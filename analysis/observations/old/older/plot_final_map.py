...
ck_bar = plt.colorbar(ck, ax=ax2, label=r'$\eta K V_{C}$  [MPa]', extend='max', shrink=0.5, pad=0.05)
...
for i, plate_thick_val in enumerate(plate_thick_vals):
    for j, T_val in enumerate(T_vals):
        ...
        DPmean_thresh, DPmean_tot = stats_DP(data)
...
mean1, std1, perc1 = stats_data_file(array1)
mean2, std2, perc2 = stats_data_file(array2)
mean3, std3, perc3 = stats_data_file(array3)
mean4, std4, perc4 = stats_data_file(array4)
mean5, std5, perc5 = stats_data_file(array5)
mean6, std6, perc6 = stats_data_file(array6)
mean7, std7, perc7 = stats_data_file(array7)
mean8, std8, perc8 = stats_data_file(array8)
mean9, std9, perc9 = stats_data_file(array9)
mean10, std10, perc10 = stats_data_file(array10)
mean11, std11, perc11 = stats_data_file(array11)
mean12, std12, perc12 = stats_data_file(array12)
mean13, std13, perc13 = stats_data_file(array13)
...
ax4.set_ylabel(r'$\eta K V_{C}$  >  100 MPa')
