...
plotname=''.join(['plots/maps.slab',str(slab_visc),'.alpha',str(alpha),'.T',str(Tm),'.k',str(diffusivity),'.platethick',str(plate_thick),'.',cooling_model,'_low-scaling-thresh.png'])
plotname_pdf=''.join(['plots/maps.slab',str(slab_visc),'.alpha',str(alpha),'.T',str(Tm),'.k',str(diffusivity),'.platethick',str(plate_thick),'.',cooling_model,'_low-scaling-thresh.pdf'])
