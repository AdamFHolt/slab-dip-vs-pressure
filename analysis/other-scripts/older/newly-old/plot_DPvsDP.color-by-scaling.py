...
from functions_plotting import plot_BvsFullForce_scalingcolored, plot_BvsDP_scalingcolored
...
if depths == "normal":
    ...
    plot_name_png = ''.join(['plots/DP-comparisons/compilations/DP-vs-DP.dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.200-to-400km.scaling-colored.png'])
    plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/DP-vs-DP.dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.200-to-400km.scaling-colored.pdf'])
elif depths == "other":
    analysis_depth1 = 250e3
    analysis_depth2 = 300e3
    analysis_depth3 = 350e3
    plot_name_png = ''.join(['plots/DP-comparisons/compilations/DP-vs-DP.dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.250-to-350km.scaling-colored.png'])
    plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/DP-vs-DP.dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.250-to-350km.scaling-colored.pdf'])
else:
...
#### SCATTER PLOTS ####name_ref_bothfree
...
for i in range(tmin,len(weak1_bothfree)):
	im = plt.scatter(weak1_bothfree[i,4]/1.e6,(weak1_bothfree[i,3]-weak1_bothfree[i,6]+weak1_bothfree[i,17])/1.e6,s=10,c=weak1_bothfree[i,11]*1e3*50*weak1_bothfree[i,19],cmap=color_map,norm=norm,edgecolor='black',linewidth=0.1,zorder=2,marker='o')
plot_BvsFullForce_scalingcolored(tmin,weak1_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=50)
plot_BvsFullForce_scalingcolored(tmin,weak1_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=50)
# 250
plot_BvsFullForce_scalingcolored(tmin,ref1_bothfree,'black','o',color_map,norm,zorder=2,viscosity=250)
plot_BvsFullForce_scalingcolored(tmin,ref1_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=250)
plot_BvsFullForce_scalingcolored(tmin,ref1_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=250)
# 375
plot_BvsFullForce_scalingcolored(tmin,new1_bothfree,'black','o',color_map,norm,zorder=2,viscosity=375)
plot_BvsFullForce_scalingcolored(tmin,new1_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=375)
plot_BvsFullForce_scalingcolored(tmin,new1_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=375)
# 500
plot_BvsFullForce_scalingcolored(tmin,ref1b_bothfree,'black','o',color_map,norm,zorder=2,viscosity=500)
plot_BvsFullForce_scalingcolored(tmin,ref1b_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=500)
plot_BvsFullForce_scalingcolored(tmin,ref1b_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=500)
# 1000
plot_BvsFullForce_scalingcolored(tmin,strong1_bothfree,'black','o',color_map,norm,zorder=2,viscosity=1000)
plot_BvsFullForce_scalingcolored(tmin,strong1_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=1000)
plot_BvsFullForce_scalingcolored(tmin,strong1_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=1000)
...
# c-bar
cbar = plt.colorbar(im, cax = fig.add_axes([0.322, 0.57, 0.008, 0.08]), orientation='vertical', ticks=[0,5], extend='max') # left, base, length left-right, length top-bott
...
# 50
plot_BvsFullForce_scalingcolored(tmin,weak2_bothfree,'black','o',color_map,norm,zorder=2,viscosity=50)
plot_BvsFullForce_scalingcolored(tmin,weak2_fixedSP,'black','v',color_map,norm, zorder=3,viscosity=50)
plot_BvsFullForce_scalingcolored(tmin,weak2_fixedOP,'black','^',color_map,norm, zorder=2,viscosity=50)
# 250
plot_BvsFullForce_scalingcolored(tmin,ref2_bothfree,'black','o',color_map,norm,zorder=2,viscosity=250)
plot_BvsFullForce_scalingcolored(tmin,ref2_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=250)
plot_BvsFullForce_scalingcolored(tmin,ref2_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=250)
# 375
plot_BvsFullForce_scalingcolored(tmin,new2_bothfree,'black','o',color_map,norm,zorder=2,viscosity=375)
plot_BvsFullForce_scalingcolored(tmin,new2_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=375)
plot_BvsFullForce_scalingcolored(tmin,new2_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=375)
# 500
plot_BvsFullForce_scalingcolored(tmin,ref2b_bothfree,'black','o',color_map,norm,zorder=2,viscosity=500)
plot_BvsFullForce_scalingcolored(tmin,ref2b_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=500)
plot_BvsFullForce_scalingcolored(tmin,ref2b_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=500)
# 1000
plot_BvsFullForce_scalingcolored(tmin,strong2_bothfree,'black','o',color_map,norm,zorder=2,viscosity=1000)
plot_BvsFullForce_scalingcolored(tmin,strong2_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=1000)
plot_BvsFullForce_scalingcolored(tmin,strong2_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=1000)
...
# 50
plot_BvsFullForce_scalingcolored(tmin,weak3_bothfree,'black','o',color_map,norm,zorder=2,viscosity=50)
plot_BvsFullForce_scalingcolored(tmin,weak3_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=50)
plot_BvsFullForce_scalingcolored(tmin,weak3_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=50)
# 250
plot_BvsFullForce_scalingcolored(tmin,ref3_bothfree,'black','o',color_map,norm,zorder=2,viscosity=250)
plot_BvsFullForce_scalingcolored(tmin,ref3_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=250)
plot_BvsFullForce_scalingcolored(tmin,ref3_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=250)
# 375
plot_BvsFullForce_scalingcolored(tmin,new3_bothfree,'black','o',color_map,norm,zorder=2,viscosity=375)
plot_BvsFullForce_scalingcolored(tmin,new3_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=375)
plot_BvsFullForce_scalingcolored(tmin,new3_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=375)
# 500
plot_BvsFullForce_scalingcolored(tmin,ref3b_bothfree,'black','o',color_map,norm,zorder=2,viscosity=500)
plot_BvsFullForce_scalingcolored(tmin,ref3b_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=500)
plot_BvsFullForce_scalingcolored(tmin,ref3b_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=500)
# 1000
plot_BvsFullForce_scalingcolored(tmin,strong3_bothfree,'black','o',color_map,norm,zorder=2,viscosity=1000)
plot_BvsFullForce_scalingcolored(tmin,strong3_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=1000)
plot_BvsFullForce_scalingcolored(tmin,strong3_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=1000)
...
# 50
plot_BvsDP_scalingcolored(tmin,weak1_bothfree,'black','o',color_map,norm,zorder=2,viscosity=50)
plot_BvsDP_scalingcolored(tmin,weak1_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=50)
plot_BvsDP_scalingcolored(tmin,weak1_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=50)
# 250
plot_BvsDP_scalingcolored(tmin,ref1_bothfree,'black','o',color_map,norm,zorder=2,viscosity=250)
plot_BvsDP_scalingcolored(tmin,ref1_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=250)
plot_BvsDP_scalingcolored(tmin,ref1_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=250)
# 375
plot_BvsDP_scalingcolored(tmin,new1_bothfree,'black','o',color_map,norm,zorder=2,viscosity=375)
plot_BvsDP_scalingcolored(tmin,new1_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=375)
plot_BvsDP_scalingcolored(tmin,new1_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=375)
# 500
plot_BvsDP_scalingcolored(tmin,ref1b_bothfree,'black','o',color_map,norm,zorder=2,viscosity=500)
plot_BvsDP_scalingcolored(tmin,ref1b_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=500)
plot_BvsDP_scalingcolored(tmin,ref1b_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=500)
# 1000
plot_BvsDP_scalingcolored(tmin,strong1_bothfree,'black','o',color_map,norm,zorder=2,viscosity=1000)
plot_BvsDP_scalingcolored(tmin,strong1_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=1000)
plot_BvsDP_scalingcolored(tmin,strong1_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=1000)
...
# 50
plot_BvsDP_scalingcolored(tmin,weak2_bothfree,'black','o',color_map,norm,zorder=2,viscosity=50)
plot_BvsDP_scalingcolored(tmin,weak2_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=50)
plot_BvsDP_scalingcolored(tmin,weak2_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=50)
# 250
plot_BvsDP_scalingcolored(tmin,ref2_bothfree,'black','o',color_map,norm,zorder=2,viscosity=250)
plot_BvsDP_scalingcolored(tmin,ref2_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=250)
plot_BvsDP_scalingcolored(tmin,ref2_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=250)
# 375
plot_BvsDP_scalingcolored(tmin,new2_bothfree,'black','o',color_map,norm,zorder=2,viscosity=375)
plot_BvsDP_scalingcolored(tmin,new2_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=375)
plot_BvsDP_scalingcolored(tmin,new2_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=375)
# 500
plot_BvsDP_scalingcolored(tmin,ref2b_bothfree,'black','o',color_map,norm,zorder=2,viscosity=500)
plot_BvsDP_scalingcolored(tmin,ref2b_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=500)
plot_BvsDP_scalingcolored(tmin,ref2b_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=500)
# 1000
plot_BvsDP_scalingcolored(tmin,strong2_bothfree,'black','o',color_map,norm,zorder=2,viscosity=1000)
plot_BvsDP_scalingcolored(tmin,strong2_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=1000)
plot_BvsDP_scalingcolored(tmin,strong2_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=1000)
...
# 50
plot_BvsDP_scalingcolored(tmin,weak3_bothfree,'black','o',color_map,norm,zorder=2,viscosity=50)
plot_BvsDP_scalingcolored(tmin,weak3_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=50)
plot_BvsDP_scalingcolored(tmin,weak3_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=50)
# 250
plot_BvsDP_scalingcolored(tmin,ref3_bothfree,'black','o',color_map,norm,zorder=2,viscosity=250)
plot_BvsDP_scalingcolored(tmin,ref3_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=250)
plot_BvsDP_scalingcolored(tmin,ref3_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=250)
# 375
plot_BvsDP_scalingcolored(tmin,new3_bothfree,'black','o',color_map,norm,zorder=2,viscosity=375)
plot_BvsDP_scalingcolored(tmin,new3_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=375)
plot_BvsDP_scalingcolored(tmin,new3_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=375)
# 500
plot_BvsDP_scalingcolored(tmin,ref3b_bothfree,'black','o',color_map,norm,zorder=2,viscosity=500)
plot_BvsDP_scalingcolored(tmin,ref3b_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=500)
plot_BvsDP_scalingcolored(tmin,ref3b_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=500)
# 1000
plot_BvsDP_scalingcolored(tmin,strong3_bothfree,'black','o',color_map,norm,zorder=2,viscosity=1000)
plot_BvsDP_scalingcolored(tmin,strong3_fixedSP,'black','v',color_map,norm,zorder=3,viscosity=1000)
plot_BvsDP_scalingcolored(tmin,strong3_fixedOP,'black','^',color_map,norm,zorder=2,viscosity=1000)
