...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/DP-vs-DP_all-mods.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.w-shear-correction_no-curvature-filtering.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/DP-vs-DP_all-mods.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.w-shear-correction_no-curvature-filtering.pdf'])
