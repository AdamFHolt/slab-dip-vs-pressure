...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/misfit-vs-K.wo-shear-correction.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/misfit-vs-K.wo-shear-correction.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.pdf'])
...
plt.scatter(weak_bothfree[:,4]/1.e6,  (weak_bothfree[:,3])/1.e6,    color='tan',     s=10,edgecolor='black',lw=0.15,zorder=3) 
plt.scatter(weak_fixedSP[:,4]/1.e6,   (weak_fixedSP[:,3])/1.e6,      color='tan',     s=10,edgecolor='black',marker='v',lw=0.15,zorder=3) 
plt.scatter(weak_fixedOP[:,4]/1.e6,   (weak_fixedOP[:,3])/1.e6,      color='tan',     s=10,edgecolor='black',marker='^',lw=0.15,zorder=3) 
plt.scatter(ref_bothfree[:,4]/1.e6,   (ref_bothfree[:,3])/1.e6,      color='peru',s=10,edgecolor='black',lw=0.15,zorder=3) 
plt.scatter(ref_fixedSP[:,4]/1.e6,    (ref_fixedSP[:,3])/1.e6,   	   color='peru',s=10,edgecolor='black',marker='v',lw=0.15,zorder=3) 
plt.scatter(ref_fixedOP[:,4]/1.e6,    (ref_fixedOP[:,3])/1.e6,        color='peru',s=10,edgecolor='black',marker='^',lw=0.15,zorder=3) 
plt.scatter(new_bothfree[:,4]/1.e6,   (new_bothfree[:,3])/1.e6,      color='firebrick',s=10,edgecolor='black',lw=0.15,zorder=3) 
plt.scatter(new_fixedSP[:,4]/1.e6,    (new_fixedSP[:,3])/1.e6,   	   color='firebrick',s=10,edgecolor='black',marker='v',lw=0.15,zorder=3) 
plt.scatter(new_fixedOP[:,4]/1.e6,    (new_fixedOP[:,3])/1.e6,        color='firebrick',s=10,edgecolor='black',marker='^',lw=0.15,zorder=3) 
plt.scatter(ref2_bothfree[:,4]/1.e6,   (ref2_bothfree[:,3])/1.e6,      color='maroon',s=10,edgecolor='black',lw=0.15,zorder=3) 
plt.scatter(ref2_fixedSP[:,4]/1.e6,    (ref2_fixedSP[:,3])/1.e6,   	   color='maroon',s=10,edgecolor='black',marker='v',lw=0.15,zorder=3) 
plt.scatter(ref2_fixedOP[:,4]/1.e6,    (ref2_fixedOP[:,3])/1.e6,        color='maroon',s=10,edgecolor='black',marker='^',lw=0.15,zorder=3) 
plt.scatter(strong_bothfree[:,4]/1.e6,(strong_bothfree[:,3])/1.e6,color='black',      s=10,edgecolor='black',lw=0.15,zorder=3) 
plt.scatter(strong_fixedSP[:,4]/1.e6, (strong_fixedSP[:,3])/1.e6,  color='black',      s=10,edgecolor='black',marker='v',lw=0.15,zorder=3) 
plt.scatter(strong_fixedOP[:,4]/1.e6, (strong_fixedOP[:,3])/1.e6,  color='black',      s=10,edgecolor='black',marker='^',lw=0.15,zorder=3) 
...
plt.scatter(weak_bothfree[:,12]*1000,  (weak_bothfree[:,3]-weak_bothfree[:,4])/1.e6,      color='tan',s=10,edgecolor='black',lw=0.15,zorder=3) 
plt.scatter(weak_fixedSP[:,12]*1000,   (weak_fixedSP[:,3]-weak_fixedSP[:,4])/1.e6,         color='tan',s=10,edgecolor='black',marker='v',lw=0.15,zorder=3) 
plt.scatter(weak_fixedOP[:,12]*1000,   (weak_fixedOP[:,3]-weak_fixedOP[:,4])/1.e6,         color='tan',s=10,edgecolor='black',marker='^',lw=0.15,zorder=3) 
plt.scatter(ref_bothfree[:,12]*1000,   (ref_bothfree[:,3]-ref_bothfree[:,4])/1.e6,         color='peru',s=10,edgecolor='black',lw=0.15,zorder=3) 
plt.scatter(ref_fixedSP[:,12]*1000,    (ref_fixedSP[:,3]-ref_fixedSP[:,4])/1.e6,            color='peru',s=10,edgecolor='black',marker='v',lw=0.15,zorder=3) 
plt.scatter(ref_fixedOP[:,12]*1000,    (ref_fixedOP[:,3]-ref_fixedOP[:,4])/1.e6,            color='peru',s=10,edgecolor='black',marker='^',lw=0.15,zorder=3)
plt.scatter(new_bothfree[:,12]*1000,   (new_bothfree[:,3]-new_bothfree[:,4])/1.e6,         color='firebrick',s=10,edgecolor='black',lw=0.15,zorder=3) 
plt.scatter(new_fixedSP[:,12]*1000,    (new_fixedSP[:,3]-new_fixedSP[:,4])/1.e6,            color='firebrick',s=10,edgecolor='black',marker='v',lw=0.15,zorder=3) 
plt.scatter(new_fixedOP[:,12]*1000,    (new_fixedOP[:,3]-new_fixedOP[:,4])/1.e6,            color='firebrick',s=10,edgecolor='black',marker='^',lw=0.15,zorder=3)
plt.scatter(ref2_bothfree[:,12]*1000,   (ref2_bothfree[:,3]-ref2_bothfree[:,4])/1.e6,         color='maroon',s=10,edgecolor='black',lw=0.15,zorder=3) 
plt.scatter(ref2_fixedSP[:,12]*1000,    (ref2_fixedSP[:,3]-ref2_fixedSP[:,4])/1.e6,            color='maroon',s=10,edgecolor='black',marker='v',lw=0.15,zorder=3) 
plt.scatter(ref2_fixedOP[:,12]*1000,    (ref2_fixedOP[:,3]-ref2_fixedOP[:,4])/1.e6,            color='maroon',s=10,edgecolor='black',marker='^',lw=0.15,zorder=3)
plt.scatter(strong_bothfree[:,12]*1000,(strong_bothfree[:,3]-strong_bothfree[:,4])/1.e6,color='black',s=10,edgecolor='black',lw=0.15,zorder=3) 
plt.scatter(strong_fixedSP[:,12]*1000, (strong_fixedSP[:,3]-strong_fixedSP[:,4])/1.e6,   color='black',s=10,edgecolor='black',marker='v',lw=0.15,zorder=3) 
plt.scatter(strong_fixedOP[:,12]*1000, (strong_fixedOP[:,3]-strong_fixedOP[:,4])/1.e6,   color='black',s=10,edgecolor='black',marker='^',lw=0.15,zorder=3) 
