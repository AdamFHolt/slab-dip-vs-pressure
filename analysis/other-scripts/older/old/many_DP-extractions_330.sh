...
m="2D_compositional_subd_lower-res_new"         # 500
maxt=23
python3 extract_properties_and_plot2.py $m $maxt $depth 10.e3 10.0e3 1.0e3

m="2D_compositional_subd_FixedSP_lower-res_new" # 500 
maxt=23
python3 extract_properties_and_plot2.py $m $maxt $depth 10.e3 10.0e3 1.0e3

m="2D_compositional_subd_FixedOP_lower-res_new" # 500
maxt=29
python3 extract_properties_and_plot2.py $m $maxt $depth 10.e3 10.0e3 1.0e3
...
m="2D_compositional_subd_lower-res_new_FixedSP_1000plates"
maxt=25
python3 extract_properties_and_plot2.py $m $maxt $depth 10.e3 10.0e3 1.0e3
