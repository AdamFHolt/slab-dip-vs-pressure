...
saved_stresses_name = ''.join(['text_files/',model_name,'.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.txt'])
...
first_time=23
saved_stresses = np.zeros(((max_time-first_time),18)) # time [Myr], DP_mod_shall, DP_mod_deep, DP_mod, DP_anal, dip, stress term, stress term B, 
                                                      # stress term C,slabnorm thick, snorm contrib, dgradient normal stress, K, dK
                                                      # vc, slab_viscosity, bending stress, bending/buoyant stress
ind = 0 
...
for time in range(first_time,max_time,1):
    ...
    saved_stresses[ind,:] = time_dim, DP_mod_shall, DP_mod_deep, DP_mod, DP_anal, dip_midmant, slab_stress_term, slab_stress_term_b, \
                            ...
                            bending_stress_midmant, bending_stress_midmant/DP_anal
    ind = ind + 1
