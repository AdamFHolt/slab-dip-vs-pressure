...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/DP-and-misfits.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.colored-by-time.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/DP-and-misfits_NewMods.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.colored-by-time.pdf'])
...
p1=plt.scatter(ref_bothfree[:,4]/1.e6,   (ref_bothfree[:,3]-ref_bothfree[:,6])/1.e6,      c=ref_bothfree[:,0], cmap='gray', vmin=15, vmax=45, s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(ref_fixedSP[:,4]/1.e6,    (ref_fixedSP[:,3]-ref_fixedSP[:,6])/1.e6,   	   c=ref_fixedSP[:,0], cmap='gray', vmin=15, vmax=45, s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(ref_fixedOP[:,4]/1.e6,    (ref_fixedOP[:,3]-ref_fixedOP[:,6])/1.e6,        c=ref_fixedOP[:,0], cmap='gray', vmin=15, vmax=45, s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(weak_bothfree[:,4]/1.e6,  (weak_bothfree[:,3]-weak_bothfree[:,6])/1.e6,    c=weak_bothfree[:,0], cmap='gray', vmin=15, vmax=45, s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(weak_fixedSP[:,4]/1.e6,   (weak_fixedSP[:,3]-weak_fixedSP[:,6])/1.e6,      c=weak_fixedSP[:,0], cmap='gray', vmin=15, vmax=45, s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(weak_fixedOP[:,4]/1.e6,   (weak_fixedOP[:,3]-weak_fixedOP[:,6])/1.e6,      c=weak_fixedOP[:,0], cmap='gray', vmin=15, vmax=45, s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(strong_bothfree[:,4]/1.e6,(strong_bothfree[:,3]-strong_bothfree[:,6])/1.e6,c=strong_bothfree[:,0], cmap='gray', vmin=15, vmax=45, s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(strong_fixedSP[:,4]/1.e6, (strong_fixedSP[:,3]-strong_fixedSP[:,6])/1.e6,  c=strong_fixedSP[:,0], cmap='gray', vmin=15, vmax=45, s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(strong_fixedOP[:,4]/1.e6, (strong_fixedOP[:,3]-strong_fixedOP[:,6])/1.e6,  c=strong_fixedOP[:,0], cmap='gray', vmin=15, vmax=45, s=10,edgecolor='black',lw=0.25,zorder=3) 
...
cbar = plt.colorbar(p1, cax = fig.add_axes([0.32, 0.575, 0.009, 0.1 ]),ticks=[15, 30, 45],extend='max') # left, base, length left-right, length top-bott
cbar.ax.tick_params(axis='y',labelsize=5,pad=1,left=True,labelleft=True,right=False,labelright=False)
cbar.ax.set_title('t [Myr]',size=6)


ax=fig.add_subplot(gs[0,1])
# curvature vs. (extracted - analytical - shear stress)
plt.scatter(ref_bothfree[:,12]*1000,   (ref_bothfree[:,3]-ref_bothfree[:,4]-ref_bothfree[:,6])/1.e6,         c=ref_bothfree[:,0], cmap='gray', vmin=15, vmax=45, s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(ref_fixedSP[:,12]*1000,    (ref_fixedSP[:,3]-ref_fixedSP[:,4]-ref_fixedSP[:,6])/1.e6,            c=ref_fixedSP[:,0], cmap='gray', vmin=15, vmax=45, s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(ref_fixedOP[:,12]*1000,    (ref_fixedOP[:,3]-ref_fixedOP[:,4]-ref_fixedOP[:,6])/1.e6,            c=ref_fixedOP[:,0], cmap='gray', vmin=15, vmax=45, s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(weak_bothfree[:,12]*1000,  (weak_bothfree[:,3]-weak_bothfree[:,4]-weak_bothfree[:,6])/1.e6,      c=weak_bothfree[:,0], cmap='gray', vmin=15, vmax=45, s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(weak_fixedSP[:,12]*1000,   (weak_fixedSP[:,3]-weak_fixedSP[:,4]-weak_fixedSP[:,6])/1.e6,         c=weak_fixedSP[:,0], cmap='gray', vmin=15, vmax=45, s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(weak_fixedOP[:,12]*1000,   (weak_fixedOP[:,3]-weak_fixedOP[:,4]-weak_fixedOP[:,6])/1.e6,         c=weak_fixedOP[:,0], cmap='gray', vmin=15, vmax=45, s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(strong_bothfree[:,12]*1000,(strong_bothfree[:,3]-strong_bothfree[:,4]-strong_bothfree[:,6])/1.e6,c=strong_bothfree[:,0], cmap='gray', vmin=15, vmax=45, s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(strong_fixedSP[:,12]*1000, (strong_fixedSP[:,3]-strong_fixedSP[:,4]-strong_fixedSP[:,6])/1.e6,   c=strong_fixedSP[:,0], cmap='gray', vmin=15, vmax=45, s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(strong_fixedOP[:,12]*1000, (strong_fixedOP[:,3]-strong_fixedOP[:,4]-strong_fixedOP[:,6])/1.e6,   c=strong_fixedOP[:,0], cmap='gray', vmin=15, vmax=45, s=10,edgecolor='black',lw=0.25,zorder=3) 
