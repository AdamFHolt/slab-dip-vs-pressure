...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/misfit-vs-shear-stress-and-dnorm-stress_all-mods.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/misfit-vs-shear-stress-and-dnorm-stress_all-mods.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.pdf'])
...
plt.scatter(ref1_bothfree[:,11],(ref1_bothfree[:,3]-ref1_bothfree[:,4]-ref1_bothfree[:,6])/1.e6,color='slategray',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(ref1_fixedSP[:,11],(ref1_fixedSP[:,3]-ref1_fixedSP[:,4]-ref1_fixedSP[:,6])/1.e6,color='slategray',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(ref1_fixedOP[:,11],(ref1_fixedOP[:,3]-ref1_fixedOP[:,4]-ref1_fixedOP[:,6])/1.e6,color='slategray',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(weak1_bothfree[:,11],(weak1_bothfree[:,3]-weak1_bothfree[:,4]-weak1_bothfree[:,6])/1.e6,color='blue',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(weak1_fixedSP[:,11],(weak1_fixedSP[:,3]-weak1_fixedSP[:,4]-weak1_fixedSP[:,6])/1.e6,color='blue',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(weak1_fixedOP[:,11],(weak1_fixedOP[:,3]-weak1_fixedOP[:,4]-weak1_fixedOP[:,6])/1.e6,color='blue',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(strong1_bothfree[:,11],(strong1_bothfree[:,3]-strong1_bothfree[:,4]-strong1_bothfree[:,6])/1.e6,color='red',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(strong1_fixedSP[:,11],(strong1_fixedSP[:,3]-strong1_fixedSP[:,4]-strong1_fixedSP[:,6])/1.e6,color='red',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(strong1_fixedOP[:,11],(strong1_fixedOP[:,3]-strong1_fixedOP[:,4]-strong1_fixedOP[:,6])/1.e6,color='red',s=10,edgecolor='black',lw=0.25,zorder=3) 
...
plt.xlabel("normal stress gradient [MPa/km]",size=6)
...
# curvature vs. (extracted - analytical - shear stress)
plt.scatter(ref2_bothfree[:,11],(ref2_bothfree[:,3]-ref2_bothfree[:,4]-ref2_bothfree[:,6])/1.e6,color='slategray',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(ref2_fixedSP[:,11],(ref2_fixedSP[:,3]-ref2_fixedSP[:,4]-ref2_fixedSP[:,6])/1.e6,color='slategray',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(ref2_fixedOP[:,11],(ref2_fixedOP[:,3]-ref2_fixedOP[:,4]-ref2_fixedOP[:,6])/1.e6,color='slategray',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(weak2_bothfree[:,11],(weak2_bothfree[:,3]-weak2_bothfree[:,4]-weak2_bothfree[:,6])/1.e6,color='blue',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(weak2_fixedSP[:,11],(weak2_fixedSP[:,3]-weak2_fixedSP[:,4]-weak2_fixedSP[:,6])/1.e6,color='blue',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(weak2_fixedOP[:,11],(weak2_fixedOP[:,3]-weak2_fixedOP[:,4]-weak2_fixedOP[:,6])/1.e6,color='blue',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(strong2_bothfree[:,11],(strong2_bothfree[:,3]-strong2_bothfree[:,4]-strong2_bothfree[:,6])/1.e6,color='red',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(strong2_fixedSP[:,11],(strong2_fixedSP[:,3]-strong2_fixedSP[:,4]-strong2_fixedSP[:,6])/1.e6,color='red',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(strong2_fixedOP[:,11],(strong2_fixedOP[:,3]-strong2_fixedOP[:,4]-strong2_fixedOP[:,6])/1.e6,color='red',s=10,edgecolor='black',lw=0.25,zorder=3) 
...
# curvature vs. (extracted - analytical - shear stress)
plt.scatter(ref3_bothfree[:,11],(ref3_bothfree[:,3]-ref3_bothfree[:,4]-ref3_bothfree[:,6])/1.e6,color='slategray',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(ref3_fixedSP[:,11],(ref3_fixedSP[:,3]-ref3_fixedSP[:,4]-ref3_fixedSP[:,6])/1.e6,color='slategray',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(ref3_fixedOP[:,11],(ref3_fixedOP[:,3]-ref3_fixedOP[:,4]-ref3_fixedOP[:,6])/1.e6,color='slategray',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(weak3_bothfree[:,11],(weak3_bothfree[:,3]-weak3_bothfree[:,4]-weak3_bothfree[:,6])/1.e6,color='blue',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(weak3_fixedSP[:,11],(weak3_fixedSP[:,3]-weak3_fixedSP[:,4]-weak3_fixedSP[:,6])/1.e6,color='blue',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(weak3_fixedOP[:,11],(weak3_fixedOP[:,3]-weak3_fixedOP[:,4]-weak3_fixedOP[:,6])/1.e6,color='blue',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(strong3_bothfree[:,11],(strong3_bothfree[:,3]-strong3_bothfree[:,4]-strong3_bothfree[:,6])/1.e6,color='red',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(strong3_fixedSP[:,11],(strong3_fixedSP[:,3]-strong3_fixedSP[:,4]-strong3_fixedSP[:,6])/1.e6,color='red',s=10,edgecolor='black',lw=0.25,zorder=3) 
plt.scatter(strong3_fixedOP[:,11],(strong3_fixedOP[:,3]-strong3_fixedOP[:,4]-strong3_fixedOP[:,6])/1.e6,color='red',s=10,edgecolor='black',lw=0.25,zorder=3) 
