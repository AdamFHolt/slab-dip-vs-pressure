...
elif model_string == "core":
    model_bothfree="2D_compositional_subd_lower-res_new_StiffCore"
    model_fixedSP="2D_compositional_subd_lower-res_new_StiffCore_FixedSP"
    model_fixedOP="2D_compositional_subd_lower-res_new_StiffCore_FixedOP"
else:
    exit()
...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/',model_string,'-mods_z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/',model_string,'-mods_z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.pdf'])
