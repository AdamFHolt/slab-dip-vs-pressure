...
name_ref_bothfree   = "2D_compositional_subd_new"
...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/all-mods_all-depths.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.w-shear-correction-curvature-filtering.tmp.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/all-mods_all-depths.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.w-shear-correction-curvature-filtering.tmp.pdf'])
...
for i in range(3,len(ref1_bothfree)):
    if np.abs(ref1_bothfree[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(ref1_bothfree[i,4]/1.e6,(ref1_bothfree[i,3]-ref1_bothfree[i,6])/1.e6,color='slategray',s=5,edgecolor='none',lw=0.1,zorder=2,alpha=0.25) 
# ref, fixed SP
for i in range(3,len(ref1_fixedSP)):
    if np.abs(ref1_fixedSP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(ref1_fixedSP[i,4]/1.e6,(ref1_fixedSP[i,3]-ref1_fixedSP[i,6])/1.e6,color='slategray',s=5,edgecolor='none',marker='v',lw=0.1,zorder=2,alpha=0.25) 
# ref, fixed OP
for i in range(3,len(ref1_fixedOP)):
    if np.abs(ref1_fixedOP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(ref1_fixedOP[i,4]/1.e6,(ref1_fixedOP[i,3]-ref1_fixedOP[i,6])/1.e6,color='slategray',s=5,edgecolor='none',marker='^',lw=0.1,zorder=2,alpha=0.25) 
...
for i in range(3,len(weak1_bothfree)):
    if np.abs(weak1_bothfree[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(weak1_bothfree[i,4]/1.e6,(weak1_bothfree[i,3]-weak1_bothfree[i,6])/1.e6,color='blue',s=5,edgecolor='none',lw=0.1,zorder=2,alpha=0.25) 
# weak, fixed SP
for i in range(3,len(weak1_fixedSP)):
    if np.abs(weak1_fixedSP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(weak1_fixedSP[i,4]/1.e6,(weak1_fixedSP[i,3]-weak1_fixedSP[i,6])/1.e6,color='blue',s=5,edgecolor='none',marker='v',lw=0.1,zorder=2,alpha=0.25) 
# weak, fixed OP
for i in range(3,len(weak1_fixedOP)):
    if np.abs(weak1_fixedOP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(weak1_fixedOP[i,4]/1.e6,(weak1_fixedOP[i,3]-weak1_fixedOP[i,6])/1.e6,color='blue',s=5,edgecolor='none',marker='^',lw=0.1,zorder=2,alpha=0.25) 
...
for i in range(3,len(strong1_bothfree)):
    if np.abs(strong1_bothfree[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(strong1_bothfree[i,4]/1.e6,(strong1_bothfree[i,3]-strong1_bothfree[i,6])/1.e6,color='red',s=5,edgecolor='none',lw=0.1,zorder=2,alpha=0.25) 
# strong, fixed SP
for i in range(3,len(strong1_fixedSP)):
    if np.abs(strong1_fixedSP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(strong1_fixedSP[i,4]/1.e6,(strong1_fixedSP[i,3]-strong1_fixedSP[i,6])/1.e6,color='red',s=5,edgecolor='none',marker='v',lw=0.1,zorder=2,alpha=0.25) 
# strong, fixed OP
for i in range(3,len(strong1_fixedOP)):
    if np.abs(strong1_fixedOP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(strong1_fixedOP[i,4]/1.e6,(strong1_fixedOP[i,3]-strong1_fixedOP[i,6])/1.e6,color='red',s=5,edgecolor='none',marker='^',lw=0.1,zorder=2,alpha=0.25) 
...
for i in range(3,len(ref2_bothfree)):
    if np.abs(ref2_bothfree[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(ref2_bothfree[i,4]/1.e6,(ref2_bothfree[i,3]-ref2_bothfree[i,6])/1.e6,color='slategray',s=5,edgecolor='none',lw=0.1,zorder=2,alpha=0.25) 
# ref, fixed SP
for i in range(3,len(ref2_fixedSP)):
    if np.abs(ref2_fixedSP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(ref2_fixedSP[i,4]/1.e6,(ref2_fixedSP[i,3]-ref2_fixedSP[i,6])/1.e6,color='slategray',s=5,edgecolor='none',marker='v',lw=0.1,zorder=2,alpha=0.25) 
# ref, fixed OP
for i in range(3,len(ref2_fixedOP)):
    if np.abs(ref2_fixedOP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(ref2_fixedOP[i,4]/1.e6,(ref2_fixedOP[i,3]-ref2_fixedOP[i,6])/1.e6,color='slategray',s=5,edgecolor='none',marker='^',lw=0.1,zorder=2,alpha=0.25) 
...
for i in range(3,len(weak2_bothfree)):
    if np.abs(weak2_bothfree[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(weak2_bothfree[i,4]/1.e6,(weak2_bothfree[i,3]-weak2_bothfree[i,6])/1.e6,color='blue',s=5,edgecolor='none',lw=0.1,zorder=2,alpha=0.25) 
# weak, fixed SP
for i in range(3,len(weak2_fixedSP)):
    if np.abs(weak2_fixedSP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(weak2_fixedSP[i,4]/1.e6,(weak2_fixedSP[i,3]-weak2_fixedSP[i,6])/1.e6,color='blue',s=5,edgecolor='none',marker='v',lw=0.1,zorder=2,alpha=0.25) 
    # weak, fixed OP
for i in range(3,len(weak2_fixedOP)):
    if np.abs(weak2_fixedOP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(weak2_fixedOP[i,4]/1.e6,(weak2_fixedOP[i,3]-weak2_fixedOP[i,6])/1.e6,color='blue',s=5,edgecolor='none',marker='^',lw=0.1,zorder=2,alpha=0.25) 
...
for i in range(3,len(strong2_bothfree)):
    if np.abs(strong2_bothfree[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(strong2_bothfree[i,4]/1.e6,(strong2_bothfree[i,3]-strong2_bothfree[i,6])/1.e6,color='red',s=5,edgecolor='none',lw=0.1,zorder=2,alpha=0.25) 
# strong, fixed SP
for i in range(3,len(strong2_fixedSP)):
    if np.abs(strong2_fixedSP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(strong2_fixedSP[i,4]/1.e6,(strong2_fixedSP[i,3]-strong2_fixedSP[i,6])/1.e6,color='red',s=5,edgecolor='none',marker='v',lw=0.1,zorder=2,alpha=0.25) 
# strong, fixed OP
for i in range(3,len(strong2_fixedOP)):
    if np.abs(strong2_fixedOP[i,12])*1000 < curvature_thresh: 
        plt.scatter(strong2_fixedOP[i,4]/1.e6,(strong2_fixedOP[i,3]-strong2_fixedOP[i,6])/1.e6,color='red',s=10,edgecolor='black',marker='^',lw=0.1,zorder=2,alpha=0.25)
    else: 
        plt.scatter(strong2_fixedOP[i,4]/1.e6,(strong2_fixedOP[i,3]-strong2_fixedOP[i,6])/1.e6,color='red',s=5,edgecolor='none',marker='^',lw=0.1,zorder=2,alpha=0.25) 
...
for i in range(3,len(ref3_bothfree)):
    if np.abs(ref3_bothfree[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(ref3_bothfree[i,4]/1.e6,(ref3_bothfree[i,3]-ref3_bothfree[i,6])/1.e6,color='slategray',s=5,edgecolor='none',lw=0.1,zorder=2,alpha=0.25) 
# ref, fixed SP
for i in range(3,len(ref3_fixedSP)):
    if np.abs(ref3_fixedSP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(ref3_fixedSP[i,4]/1.e6,(ref3_fixedSP[i,3]-ref3_fixedSP[i,6])/1.e6,color='slategray',s=5,edgecolor='none',marker='v',lw=0.1,zorder=2,alpha=0.25) 
# ref, fixed OP
for i in range(3,len(ref3_fixedOP)):
    if np.abs(ref3_fixedOP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(ref3_fixedOP[i,4]/1.e6,(ref3_fixedOP[i,3]-ref3_fixedOP[i,6])/1.e6,color='slategray',s=5,edgecolor='none',marker='^',lw=0.1,zorder=2,alpha=0.25) 
...
for i in range(3,len(weak3_bothfree)):
    if np.abs(weak3_bothfree[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(weak3_bothfree[i,4]/1.e6,(weak3_bothfree[i,3]-weak3_bothfree[i,6])/1.e6,color='blue',s=5,edgecolor='none',lw=0.1,zorder=2,alpha=0.25) 
# weak, fixed SP
for i in range(3,len(weak3_fixedSP)):
    if np.abs(weak3_fixedSP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(weak3_fixedSP[i,4]/1.e6,(weak3_fixedSP[i,3]-weak3_fixedSP[i,6])/1.e6,color='blue',s=5,edgecolor='none',marker='v',lw=0.1,zorder=2,alpha=0.25) 
# weak, fixed OP
for i in range(3,len(weak3_fixedOP)):
    if np.abs(weak3_fixedOP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(weak3_fixedOP[i,4]/1.e6,(weak3_fixedOP[i,3]-weak3_fixedOP[i,6])/1.e6,color='blue',s=5,edgecolor='none',marker='^',lw=0.1,zorder=2,alpha=0.25) 
...
for i in range(3,len(strong3_bothfree)):
    if np.abs(strong3_bothfree[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(strong3_bothfree[i,4]/1.e6,(strong3_bothfree[i,3]-strong3_bothfree[i,6])/1.e6,color='red',s=5,edgecolor='none',lw=0.1,zorder=2,alpha=0.25) 
# strong, fixed SP
for i in range(3,len(strong3_fixedSP)):
    if np.abs(strong3_fixedSP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(strong3_fixedSP[i,4]/1.e6,(strong3_fixedSP[i,3]-strong3_fixedSP[i,6])/1.e6,color='red',s=5,edgecolor='none',marker='v',lw=0.1,zorder=2,alpha=0.25) 
# strong, fixed OP
for i in range(3,len(strong3_fixedOP)):
    if np.abs(strong3_fixedOP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(strong3_fixedOP[i,4]/1.e6,(strong3_fixedOP[i,3]-strong3_fixedOP[i,6])/1.e6,color='red',s=5,edgecolor='none',marker='^',lw=0.1,zorder=2,alpha=0.25) 
