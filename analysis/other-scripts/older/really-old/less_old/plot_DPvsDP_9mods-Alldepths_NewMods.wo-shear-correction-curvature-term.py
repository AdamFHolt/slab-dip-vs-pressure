...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/all-mods_all-depths_NewMods.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.wo-shear-correction-curvature-term.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/all-mods_all-depths_NewMods.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.wo-shear-correction-curvature-term.pdf'])
...
for i in range(3,len(ref1_bothfree)):
    plt.scatter(ref1_bothfree[i,4]/1.e6,(ref1_bothfree[i,3]-ref1_bothfree[i,20])/1.e6,color='peru',s=10,edgecolor='black',lw=0.1,zorder=3) 
# ref, fixed SP
for i in range(3,len(ref1_fixedSP)):
    plt.scatter(ref1_fixedSP[i,4]/1.e6,(ref1_fixedSP[i,3]-ref1_fixedSP[i,20])/1.e6,color='peru',s=10,edgecolor='black',marker='v',lw=0.1,zorder=3) 
# ref, fixed OP
for i in range(3,len(ref1_fixedOP)):
    plt.scatter(ref1_fixedOP[i,4]/1.e6,(ref1_fixedOP[i,3]-ref1_fixedOP[i,20])/1.e6,color='peru',s=10,edgecolor='black',marker='^',lw=0.1,zorder=3) 
# ref2, free
for i in range(3,len(ref1b_bothfree)):
    plt.scatter(ref1b_bothfree[i,4]/1.e6,(ref1b_bothfree[i,3]-ref1b_bothfree[i,20])/1.e6,color='brown',s=10,edgecolor='black',lw=0.1,zorder=3) 
# ref2, fixed SP
for i in range(3,len(ref1b_fixedSP)):
    plt.scatter(ref1b_fixedSP[i,4]/1.e6,(ref1b_fixedSP[i,3]-ref1b_fixedSP[i,20])/1.e6,color='brown',s=10,edgecolor='black',marker='v',lw=0.1,zorder=3) 
# ref2, fixed OP
for i in range(3,len(ref1b_fixedOP)):
    plt.scatter(ref1b_fixedOP[i,4]/1.e6,(ref1b_fixedOP[i,3]-ref1b_fixedOP[i,20])/1.e6,color='brown',s=10,edgecolor='black',marker='^',lw=0.1,zorder=3) 
# weak, free
for i in range(3,len(weak1_bothfree)):
    plt.scatter(weak1_bothfree[i,4]/1.e6,(weak1_bothfree[i,3]-weak1_bothfree[i,20])/1.e6,color='tan',s=10,edgecolor='black',lw=0.1,zorder=3) 
# weak, fixed SP
for i in range(3,len(weak1_fixedSP)):
    plt.scatter(weak1_fixedSP[i,4]/1.e6,(weak1_fixedSP[i,3]-weak1_fixedSP[i,20])/1.e6,color='tan',s=10,edgecolor='black',marker='v',lw=0.1,zorder=3) 
# weak, fixed OP
for i in range(3,len(weak1_fixedOP)):
    plt.scatter(weak1_fixedOP[i,4]/1.e6,(weak1_fixedOP[i,3]-weak1_fixedOP[i,20])/1.e6,color='tan',s=10,edgecolor='black',marker='^',lw=0.1,zorder=3) 
# strong, free
for i in range(3,len(strong1_bothfree)):
    plt.scatter(strong1_bothfree[i,4]/1.e6,(strong1_bothfree[i,3]-strong1_bothfree[i,20])/1.e6,color='black',s=10,edgecolor='black',lw=0.1,zorder=3) 
# strong, fixed SP
for i in range(3,len(strong1_fixedSP)):
    plt.scatter(strong1_fixedSP[i,4]/1.e6,(strong1_fixedSP[i,3]-strong1_fixedSP[i,20])/1.e6,color='black',s=10,edgecolor='black',marker='v',lw=0.1,zorder=3) 
# strong, fixed OP
for i in range(3,len(strong1_fixedOP)):
    plt.scatter(strong1_fixedOP[i,4]/1.e6,(strong1_fixedOP[i,3]-strong1_fixedOP[i,20])/1.e6,color='black',s=10,edgecolor='black',marker='^',lw=0.1,zorder=3) 
...
for i in range(3,len(ref2_bothfree)):
    plt.scatter(ref2_bothfree[i,4]/1.e6,(ref2_bothfree[i,3]-ref2_bothfree[i,20])/1.e6,color='peru',s=10,edgecolor='black',lw=0.1,zorder=3) 
# ref, fixed SP
for i in range(3,len(ref2_fixedSP)):
    plt.scatter(ref2_fixedSP[i,4]/1.e6,(ref2_fixedSP[i,3]-ref2_fixedSP[i,20])/1.e6,color='peru',s=10,edgecolor='black',marker='v',lw=0.1,zorder=3) 
# ref, fixed OP
for i in range(3,len(ref2_fixedOP)):
    plt.scatter(ref2_fixedOP[i,4]/1.e6,(ref2_fixedOP[i,3]-ref2_fixedOP[i,20])/1.e6,color='peru',s=10,edgecolor='black',marker='^',lw=0.1,zorder=3) 
# ref2, free
for i in range(3,len(ref2b_bothfree)):
    plt.scatter(ref2b_bothfree[i,4]/1.e6,(ref2b_bothfree[i,3]-ref2b_bothfree[i,20])/1.e6,color='brown',s=10,edgecolor='black',lw=0.1,zorder=3) 
# ref2, fixed SP
for i in range(3,len(ref2b_fixedSP)):
    plt.scatter(ref2b_fixedSP[i,4]/1.e6,(ref2b_fixedSP[i,3]-ref2b_fixedSP[i,20])/1.e6,color='brown',s=10,edgecolor='black',marker='v',lw=0.1,zorder=3) 
# ref2, fixed OP
for i in range(3,len(ref2b_fixedOP)):
    plt.scatter(ref2b_fixedOP[i,4]/1.e6,(ref2b_fixedOP[i,3]-ref2b_fixedOP[i,20])/1.e6,color='brown',s=10,edgecolor='black',marker='^',lw=0.1,zorder=3) 
# weak, free
for i in range(3,len(weak2_bothfree)):
    plt.scatter(weak2_bothfree[i,4]/1.e6,(weak2_bothfree[i,3]-weak2_bothfree[i,20])/1.e6,color='tan',s=10,edgecolor='black',lw=0.1,zorder=3) 
# weak, fixed SP
for i in range(3,len(weak2_fixedSP)):
    plt.scatter(weak2_fixedSP[i,4]/1.e6,(weak2_fixedSP[i,3]-weak2_fixedSP[i,20])/1.e6,color='tan',s=10,edgecolor='black',marker='v',lw=0.1,zorder=3) 
# weak, fixed OP
for i in range(3,len(weak2_fixedOP)):
    plt.scatter(weak2_fixedOP[i,4]/1.e6,(weak2_fixedOP[i,3]-weak2_fixedOP[i,20])/1.e6,color='tan',s=10,edgecolor='black',marker='^',lw=0.1,zorder=3) 
# strong, free
for i in range(3,len(strong2_bothfree)):
    plt.scatter(strong2_bothfree[i,4]/1.e6,(strong2_bothfree[i,3]-strong2_bothfree[i,20])/1.e6,color='black',s=10,edgecolor='black',lw=0.1,zorder=3) 
# strong, fixed SP
for i in range(3,len(strong2_fixedSP)):
    plt.scatter(strong2_fixedSP[i,4]/1.e6,(strong2_fixedSP[i,3]-strong2_fixedSP[i,20])/1.e6,color='black',s=10,edgecolor='black',marker='v',lw=0.1,zorder=3) 
# strong, fixed OP
for i in range(3,len(strong2_fixedOP)):
    plt.scatter(strong2_fixedOP[i,4]/1.e6,(strong2_fixedOP[i,3]-strong2_fixedOP[i,20])/1.e6,color='black',s=10,edgecolor='black',marker='^',lw=0.1,zorder=3) 
...
for i in range(3,len(ref3_bothfree)):
    plt.scatter(ref3_bothfree[i,4]/1.e6,(ref3_bothfree[i,3]-ref3_bothfree[i,20])/1.e6,color='peru',s=10,edgecolor='black',lw=0.1,zorder=3) 
# ref, fixed SP
for i in range(3,len(ref3_fixedSP)):
    plt.scatter(ref3_fixedSP[i,4]/1.e6,(ref3_fixedSP[i,3]-ref3_fixedSP[i,20])/1.e6,color='peru',s=10,edgecolor='black',marker='v',lw=0.1,zorder=3) 
# ref, fixed OP
for i in range(3,len(ref3_fixedOP)):
    plt.scatter(ref3_fixedOP[i,4]/1.e6,(ref3_fixedOP[i,3]-ref3_fixedOP[i,20])/1.e6,color='peru',s=10,edgecolor='black',marker='^',lw=0.1,zorder=3) 
# ref2, free
for i in range(3,len(ref3b_bothfree)):
    plt.scatter(ref3b_bothfree[i,4]/1.e6,(ref3b_bothfree[i,3]-ref3b_bothfree[i,20])/1.e6,color='brown',s=10,edgecolor='black',lw=0.1,zorder=3) 
# ref2, fixed SP
for i in range(3,len(ref3b_fixedSP)):
    plt.scatter(ref3b_fixedSP[i,4]/1.e6,(ref3b_fixedSP[i,3]-ref3b_fixedSP[i,20])/1.e6,color='brown',s=10,edgecolor='black',marker='v',lw=0.1,zorder=3) 
# ref2, fixed OP
for i in range(3,len(ref3b_fixedOP)):
    plt.scatter(ref3b_fixedOP[i,4]/1.e6,(ref3b_fixedOP[i,3]-ref3b_fixedOP[i,20])/1.e6,color='brown',s=10,edgecolor='black',marker='^',lw=0.1,zorder=3) 
# weak, free
for i in range(3,len(weak3_bothfree)):
    plt.scatter(weak3_bothfree[i,4]/1.e6,(weak3_bothfree[i,3]-weak3_bothfree[i,20])/1.e6,color='tan',s=10,edgecolor='black',lw=0.1,zorder=3) 
# weak, fixed SP
for i in range(3,len(weak3_fixedSP)):
    plt.scatter(weak3_fixedSP[i,4]/1.e6,(weak3_fixedSP[i,3]-weak3_fixedSP[i,20])/1.e6,color='tan',s=10,edgecolor='black',marker='v',lw=0.1,zorder=3) 
# weak, fixed OP
for i in range(3,len(weak3_fixedOP)):
    plt.scatter(weak3_fixedOP[i,4]/1.e6,(weak3_fixedOP[i,3]-weak3_fixedOP[i,20])/1.e6,color='tan',s=10,edgecolor='black',marker='^',lw=0.1,zorder=3) 
# strong, free
for i in range(3,len(strong3_bothfree)):
    plt.scatter(strong3_bothfree[i,4]/1.e6,(strong3_bothfree[i,3]-strong3_bothfree[i,20])/1.e6,color='black',s=10,edgecolor='black',lw=0.1,zorder=3) 
# strong, fixed SP
for i in range(3,len(strong3_fixedSP)):
    plt.scatter(strong3_fixedSP[i,4]/1.e6,(strong3_fixedSP[i,3]-strong3_fixedSP[i,20])/1.e6,color='black',s=10,edgecolor='black',marker='v',lw=0.1,zorder=3) 
# strong, fixed OP
for i in range(3,len(strong3_fixedOP)):
    plt.scatter(strong3_fixedOP[i,4]/1.e6,(strong3_fixedOP[i,3]-strong3_fixedOP[i,20])/1.e6,color='black',s=10,edgecolor='black',marker='^',lw=0.1,zorder=3) 
