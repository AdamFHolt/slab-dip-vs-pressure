...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/all-mods_z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.w-shear-correction-curvature-filtering.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/all-mods_z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.w-shear-correction-curvature-filtering.pdf'])
...
for i in range(3,len(weak_bothfree)):
    if np.abs(weak_bothfree[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(weak_bothfree[i,4]/1.e6,(weak_bothfree[i,3]-weak_bothfree[i,6])/1.e6,color='slategray',s=7,label='both free',lw=0,zorder=4,alpha=0.5) # corrected
...
for i in range(3,len(weak_fixedSP)):
    if np.abs(weak_fixedSP[i,12])*1000 < curvature_thresh:     
        ...
        plt.scatter(weak_fixedSP[i,4]/1.e6,(weak_fixedSP[i,3]-weak_fixedSP[i,6])/1.e6,color='slateblue',s=7,label='fixed SP',lw=0,zorder=4,alpha=0.5) # corrected
# fixed OP
for i in range(3,len(weak_fixedOP)):
    if np.abs(weak_fixedOP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(weak_fixedOP[i,4]/1.e6,(weak_fixedOP[i,3]-weak_fixedOP[i,6])/1.e6,color='darkseagreen',s=7,label='fixed OP',lw=0,zorder=4,alpha=0.5) # corrected
...
for i in range(3,len(ref_bothfree)):
    if np.abs(ref_bothfree[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(ref_bothfree[i,4]/1.e6,(ref_bothfree[i,3]-ref_bothfree[i,6])/1.e6,color='slategray',s=7,label='both free',lw=0,zorder=4,alpha=0.5) # corrected
# fixed SP
for i in range(3,len(ref_fixedSP)):
    if np.abs(ref_fixedSP[i,12])*1000 < curvature_thresh:     
        ...
        plt.scatter(ref_fixedSP[i,4]/1.e6,(ref_fixedSP[i,3]-ref_fixedSP[i,6])/1.e6,color='slateblue',s=7,label='fixed SP',lw=0,zorder=4,alpha=0.5) # corrected
# fixed OP
for i in range(3,len(ref_fixedOP)):
    if np.abs(ref_fixedOP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(ref_fixedOP[i,4]/1.e6,(ref_fixedOP[i,3]-ref_fixedOP[i,6])/1.e6,color='darkseagreen',s=7,label='fixed OP',lw=0,zorder=4,alpha=0.5) # corrected
...
for i in range(3,len(strong_bothfree)):
    if np.abs(strong_bothfree[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(strong_bothfree[i,4]/1.e6,(strong_bothfree[i,3]-strong_bothfree[i,6])/1.e6,color='slategray',s=7,label='both free',lw=0,zorder=4,alpha=0.5) # corrected        
# fixed SP
for i in range(3,len(strong_fixedSP)):
    if np.abs(strong_fixedSP[i,12])*1000 < curvature_thresh:     
        ...
        plt.scatter(strong_fixedSP[i,4]/1.e6,(strong_fixedSP[i,3]-strong_fixedSP[i,6])/1.e6,color='slateblue',s=7,label='fixed SP',lw=0,zorder=4,alpha=0.5) # corrected
# fixed OP
for i in range(3,len(strong_fixedOP)):
    if np.abs(strong_fixedOP[i,12])*1000 < curvature_thresh: 
        ...
        plt.scatter(strong_fixedOP[i,4]/1.e6,(strong_fixedOP[i,3]-strong_fixedOP[i,6])/1.e6,color='darkseagreen',s=7,label='fixed OP',lw=0,zorder=4,alpha=0.5) # corrected
