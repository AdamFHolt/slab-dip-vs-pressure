...
saved_stresses = np.zeros(((max_time-9)+1,9)) # time [Myr], DP_mod_shall, DP_mod_deep, DP_mod, DP_anal, dip, stress term, stress term B, stress term C
ind = 0 

# for time in range(9,max_time+1,1):

for time in np.array([10]):
    ...
    saved_stresses[ind,:] = time_dim, DP_mod_shall, DP_mod_deep, DP_mod, DP_anal, dip_midmant, slab_stress_term, slab_stress_term_b, slab_stress_term_c
    ind = ind + 1
