...
plot_name_png = ''.join([plot_loc,'/',model_name,'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.w-bending.png'])
plot_name_pdf = ''.join([plot_loc,'/',model_name,'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.w-bending.pdf'])
...
bending_ratio_thresh = 1.5
for i in range(2,len(model1)):
	if np.abs(model1[i,17]) < bending_ratio_thresh:	
...
for i in range(2,len(model2)):
	if np.abs(model2[i,17]) < bending_ratio_thresh:	
...
for i in range(2,len(model3)):
	if np.abs(model3[i,17]) < bending_ratio_thresh:	
