...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/DP-and-misfits.w-shear-correction.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/DP-and-misfits.w-shear-correction.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.pdf'])
...
plt.scatter(ref2_bothfree[:,4]/1.e6,   (ref2_bothfree[:,3]-ref2_bothfree[:,6])/1.e6,      color='brown',s=10,edgecolor='black',lw=0.15,zorder=3) 
plt.scatter(ref2_fixedSP[:,4]/1.e6,    (ref2_fixedSP[:,3]-ref2_fixedSP[:,6])/1.e6,   	   color='brown',s=10,edgecolor='black',marker='v',lw=0.15,zorder=3) 
plt.scatter(ref2_fixedOP[:,4]/1.e6,    (ref2_fixedOP[:,3]-ref2_fixedOP[:,6])/1.e6,        color='brown',s=10,edgecolor='black',marker='^',lw=0.15,zorder=3) 
...
plt.scatter(ref2_bothfree[:,12]*1000,   (ref2_bothfree[:,3]-ref2_bothfree[:,4]-ref2_bothfree[:,6])/1.e6,         color='brown',s=10,edgecolor='black',lw=0.15,zorder=3) 
plt.scatter(ref2_fixedSP[:,12]*1000,    (ref2_fixedSP[:,3]-ref2_fixedSP[:,4]-ref2_fixedSP[:,6])/1.e6,            color='brown',s=10,edgecolor='black',marker='v',lw=0.15,zorder=3) 
plt.scatter(ref2_fixedOP[:,12]*1000,    (ref2_fixedOP[:,3]-ref2_fixedOP[:,4]-ref2_fixedOP[:,6])/1.e6,            color='brown',s=10,edgecolor='black',marker='^',lw=0.15,zorder=3)
