...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/DP-and-misfits.w-shear-correction.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.threshold-time',str(threshold_time),'Myr.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/DP-and-misfits.w-shear-correction.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.threshold-time',str(threshold_time),'Myr.pdf'])
...
for i in range(len(ref2_bothfree)):
	if ref2_bothfree[i,0] > threshold_time:
		plt.scatter(ref2_bothfree[i,12]*1000,   (ref2_bothfree[i,3]-ref2_bothfree[i,4]-ref2_bothfree[i,6])/1.e6,         color='brown',s=10,edgecolor='black',lw=0.15,zorder=3) 
	else:
		plt.scatter(ref2_bothfree[i,12]*1000,   (ref2_bothfree[i,3]-ref2_bothfree[i,4]-ref2_bothfree[i,6])/1.e6,         color='brown',s=5,edgecolor='black',lw=0.15,zorder=3,alpha=0.2) 

for i in range(len(ref2_fixedSP)):
	if ref2_fixedSP[i,0] > threshold_time:
		plt.scatter(ref2_fixedSP[i,12]*1000,    (ref2_fixedSP[i,3]-ref2_fixedSP[i,4]-ref2_fixedSP[i,6])/1.e6,            color='brown',s=10,edgecolor='black',marker='v',lw=0.15,zorder=3) 
	else:
		plt.scatter(ref2_fixedSP[i,12]*1000,    (ref2_fixedSP[i,3]-ref2_fixedSP[i,4]-ref2_fixedSP[i,6])/1.e6,            color='brown',s=5,edgecolor='black',marker='v',lw=0.15,zorder=3,alpha=0.2) 

for i in range(len(ref2_fixedOP)):
	if ref2_fixedOP[i,0] > threshold_time:
		plt.scatter(ref2_fixedOP[i,12]*1000,    (ref2_fixedOP[i,3]-ref2_fixedOP[i,4]-ref2_fixedOP[i,6])/1.e6,            color='brown',s=10,edgecolor='black',marker='^',lw=0.15,zorder=3)
	else:
		plt.scatter(ref2_fixedOP[i,12]*1000,    (ref2_fixedOP[i,3]-ref2_fixedOP[i,4]-ref2_fixedOP[i,6])/1.e6,            color='brown',s=5,edgecolor='black',marker='^',lw=0.15,zorder=3,alpha=0.2)
