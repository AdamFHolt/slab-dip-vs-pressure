...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/averaged-misfits-vs-curvature.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/averaged-misfits-vs-curvature.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.pdf'])
...
plt.plot([mean_m375_fixedSP,mean_m375_fixedSP], [mean_woshear_m375_fixedSP-stdev_woshear_m375_fixedSP,mean_woshear_m375_fixedSP+stdev_woshear_m375_fixedSP],  color='firebrick',linewidth=3.5,zorder=2,alpha=0.5)
plt.scatter(mean_m375_bothfree,mean_woshear_m375_bothfree,s=20,color='firebrick',edgecolor='black',linewidth=0.25,zorder=3) 
plt.plot([mean_m375_bothfree,mean_m375_bothfree], [mean_woshear_m375_bothfree-stdev_woshear_m375_bothfree,mean_woshear_m375_bothfree+stdev_woshear_m375_bothfree],  color='firebrick',linewidth=3.5,zorder=2,alpha=0.5)
...
plt.plot([mean_m375_fixedOP,mean_m375_fixedOP], [mean_woshear_m375_fixedOP-stdev_woshear_m375_fixedOP,mean_woshear_m375_fixedOP+stdev_woshear_m375_fixedOP],  color='firebrick',linewidth=3.5,zorder=2,alpha=0.5) 
# 500
...
plt.plot([mean_m500_fixedSP,mean_m500_fixedSP], [mean_woshear_m500_fixedSP-stdev_woshear_m500_fixedSP,mean_woshear_m500_fixedSP+stdev_woshear_m500_fixedSP],  color='maroon',linewidth=3.5,zorder=2,alpha=0.5)
plt.scatter(mean_m500_bothfree,mean_woshear_m500_bothfree,s=20,color='maroon',edgecolor='black',linewidth=0.25,zorder=3) 
plt.plot([mean_m500_bothfree,mean_m500_bothfree], [mean_woshear_m500_bothfree-stdev_woshear_m500_bothfree,mean_woshear_m500_bothfree+stdev_woshear_m500_bothfree],  color='maroon',linewidth=3.5,zorder=2,alpha=0.5)
plt.scatter(mean_m500_fixedOP,mean_woshear_m500_fixedOP,s=20,color='maroon',edgecolor='black',linewidth=0.25,zorder=3,marker='^')
plt.plot([mean_m500_fixedOP,mean_m500_fixedOP], [mean_woshear_m500_fixedOP-stdev_woshear_m500_fixedOP,mean_woshear_m500_fixedOP+stdev_woshear_m500_fixedOP],  color='maroon',linewidth=3.5,zorder=2,alpha=0.5) 
# 1000
...
plt.plot([mean_m375_fixedSP,mean_m375_fixedSP], [mean_wshear_m375_fixedSP-stdev_wshear_m375_fixedSP,mean_wshear_m375_fixedSP+stdev_wshear_m375_fixedSP],  color='brown',linewidth=3.5,zorder=2,alpha=0.5)
plt.scatter(mean_m375_bothfree,mean_wshear_m375_bothfree,s=20,color='brown',edgecolor='black',linewidth=0.25,zorder=3) 
plt.plot([mean_m375_bothfree,mean_m375_bothfree], [mean_wshear_m375_bothfree-stdev_wshear_m375_bothfree,mean_wshear_m375_bothfree+stdev_wshear_m375_bothfree],  color='brown',linewidth=3.5,zorder=2,alpha=0.5)
plt.scatter(mean_m375_fixedOP,mean_wshear_m375_fixedOP,s=20,color='brown',edgecolor='black',linewidth=0.25,zorder=3,marker='^')
plt.plot([mean_m375_fixedOP,mean_m375_fixedOP], [mean_wshear_m375_fixedOP-stdev_wshear_m375_fixedOP,mean_wshear_m375_fixedOP+stdev_wshear_m375_fixedOP],  color='brown',linewidth=3.5,zorder=2,alpha=0.5) 
# 500
...
plt.plot([mean_m500_fixedSP,mean_m500_fixedSP], [mean_wshear_m500_fixedSP-stdev_wshear_m500_fixedSP,mean_wshear_m500_fixedSP+stdev_wshear_m500_fixedSP],  color='firebrick',linewidth=3.5,zorder=2,alpha=0.5)
plt.scatter(mean_m500_bothfree,mean_wshear_m500_bothfree,s=20,color='firebrick',edgecolor='black',linewidth=0.25,zorder=3) 
plt.plot([mean_m500_bothfree,mean_m500_bothfree], [mean_wshear_m500_bothfree-stdev_wshear_m500_bothfree,mean_wshear_m500_bothfree+stdev_wshear_m500_bothfree],  color='firebrick',linewidth=3.5,zorder=2,alpha=0.5)
...
plt.plot([mean_m500_fixedOP,mean_m500_fixedOP], [mean_wshear_m500_fixedOP-stdev_wshear_m500_fixedOP,mean_wshear_m500_fixedOP+stdev_wshear_m500_fixedOP],  color='firebrick',linewidth=3.5,zorder=2,alpha=0.5) 
# 1000
...
ax.tick_params(axis='x', labelsize=6)
ax.tick_params(axis='y', labelsize=6)
plt.ylabel("misfit (w/ shear)  [MPa]",size=6)
plt.xlabel("curvature  [1/km]",size=6)
plt.ylim(-2,  15); 
fixed_aspect_ratio(0.8)
plt.xlim(0,  0.002); 
