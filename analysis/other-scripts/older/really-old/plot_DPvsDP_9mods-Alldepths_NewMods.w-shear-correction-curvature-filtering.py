...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/all-mods_all-depths_NewMods.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.w-shear-correction-curvature-filtering.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/all-mods_all-depths_NewMods.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.w-shear-correction-curvature-filtering.pdf'])
...
for i in range(3,len(ref1b_bothfree)):
    if np.abs(ref1b_bothfree[i,12])*1000 < curvature_thresh: 
        plt.scatter(ref1b_bothfree[i,4]/1.e6,(ref1b_bothfree[i,3]-ref1b_bothfree[i,6])/1.e6,color='brown',s=10,edgecolor='black',lw=0.1,zorder=3) 
    else:
        plt.scatter(ref1b_bothfree[i,4]/1.e6,(ref1b_bothfree[i,3]-ref1b_bothfree[i,6])/1.e6,color='brown',s=5,edgecolor='none',lw=0.1,zorder=2,alpha=0.2) 
# ref2, fixed SP
for i in range(3,len(ref1b_fixedSP)):
    if np.abs(ref1b_fixedSP[i,12])*1000 < curvature_thresh: 
        plt.scatter(ref1b_fixedSP[i,4]/1.e6,(ref1b_fixedSP[i,3]-ref1b_fixedSP[i,6])/1.e6,color='brown',s=10,edgecolor='black',marker='v',lw=0.1,zorder=3) 
    else:
        plt.scatter(ref1b_fixedSP[i,4]/1.e6,(ref1b_fixedSP[i,3]-ref1b_fixedSP[i,6])/1.e6,color='brown',s=5,edgecolor='none',marker='v',lw=0.1,zorder=2,alpha=0.2) 
# ref2, fixed OP
for i in range(3,len(ref1b_fixedOP)):
    if np.abs(ref1b_fixedOP[i,12])*1000 < curvature_thresh: 
        plt.scatter(ref1b_fixedOP[i,4]/1.e6,(ref1b_fixedOP[i,3]-ref1b_fixedOP[i,6])/1.e6,color='brown',s=10,edgecolor='black',marker='^',lw=0.1,zorder=3)
    else:
        plt.scatter(ref1b_fixedOP[i,4]/1.e6,(ref1b_fixedOP[i,3]-ref1b_fixedOP[i,6])/1.e6,color='brown',s=5,edgecolor='none',marker='^',lw=0.1,zorder=2,alpha=0.2) 
...
for i in range(3,len(ref2b_bothfree)):
    if np.abs(ref2b_bothfree[i,12])*1000 < curvature_thresh: 
        plt.scatter(ref2b_bothfree[i,4]/1.e6,(ref2b_bothfree[i,3]-ref2b_bothfree[i,6])/1.e6,color='brown',s=10,edgecolor='black',lw=0.1,zorder=3)
    else:
        plt.scatter(ref2b_bothfree[i,4]/1.e6,(ref2b_bothfree[i,3]-ref2b_bothfree[i,6])/1.e6,color='brown',s=5,edgecolor='none',lw=0.1,zorder=2,alpha=0.2) 
# ref2, fixed SP
for i in range(3,len(ref2b_fixedSP)):
    if np.abs(ref2b_fixedSP[i,12])*1000 < curvature_thresh: 
        plt.scatter(ref2b_fixedSP[i,4]/1.e6,(ref2b_fixedSP[i,3]-ref2b_fixedSP[i,6])/1.e6,color='brown',s=10,edgecolor='black',marker='v',lw=0.1,zorder=3)
    else:
        plt.scatter(ref2b_fixedSP[i,4]/1.e6,(ref2b_fixedSP[i,3]-ref2b_fixedSP[i,6])/1.e6,color='brown',s=5,edgecolor='none',marker='v',lw=0.1,zorder=2,alpha=0.2) 
# ref2, fixed OP
for i in range(3,len(ref2b_fixedOP)):
    if np.abs(ref2b_fixedOP[i,12])*1000 < curvature_thresh: 
        plt.scatter(ref2b_fixedOP[i,4]/1.e6,(ref2b_fixedOP[i,3]-ref2b_fixedOP[i,6])/1.e6,color='brown',s=10,edgecolor='black',marker='^',lw=0.1,zorder=3) 
    else:
        plt.scatter(ref2b_fixedOP[i,4]/1.e6,(ref2b_fixedOP[i,3]-ref2b_fixedOP[i,6])/1.e6,color='brown',s=5,edgecolor='none',marker='^',lw=0.1,zorder=2,alpha=0.2) 
...
for i in range(3,len(strong2_fixedOP)):
    if np.abs(strong2_fixedOP[i,12])*1000 < curvature_thresh: 
        plt.scatter(strong2_fixedOP[i,4]/1.e6,(strong2_fixedOP[i,3]-strong2_fixedOP[i,6])/1.e6,color='black',s=10,edgecolor='black',marker='^',lw=0.1,zorder=2,alpha=0.2)
    else: 
...
for i in range(3,len(ref3b_bothfree)):
    if np.abs(ref3b_bothfree[i,12])*1000 < curvature_thresh: 
        plt.scatter(ref3b_bothfree[i,4]/1.e6,(ref3b_bothfree[i,3]-ref3b_bothfree[i,6])/1.e6,color='brown',s=10,edgecolor='black',lw=0.1,zorder=3)
    else:
        plt.scatter(ref3b_bothfree[i,4]/1.e6,(ref3b_bothfree[i,3]-ref3b_bothfree[i,6])/1.e6,color='brown',s=5,edgecolor='none',lw=0.1,zorder=2,alpha=0.2) 
# ref2, fixed SP
for i in range(3,len(ref3b_fixedSP)):
    if np.abs(ref3b_fixedSP[i,12])*1000 < curvature_thresh: 
        plt.scatter(ref3b_fixedSP[i,4]/1.e6,(ref3b_fixedSP[i,3]-ref3b_fixedSP[i,6])/1.e6,color='brown',s=10,edgecolor='black',marker='v',lw=0.1,zorder=3)
    else:
        plt.scatter(ref3b_fixedSP[i,4]/1.e6,(ref3b_fixedSP[i,3]-ref3b_fixedSP[i,6])/1.e6,color='brown',s=5,edgecolor='none',marker='v',lw=0.1,zorder=2,alpha=0.2) 
# ref2, fixed OP
for i in range(3,len(ref3b_fixedOP)):
    if np.abs(ref3b_fixedOP[i,12])*1000 < curvature_thresh: 
        plt.scatter(ref3b_fixedOP[i,4]/1.e6,(ref3b_fixedOP[i,3]-ref3b_fixedOP[i,6])/1.e6,color='brown',s=10,edgecolor='black',marker='^',lw=0.1,zorder=3)
    else: 
        plt.scatter(ref3b_fixedOP[i,4]/1.e6,(ref3b_fixedOP[i,3]-ref3b_fixedOP[i,6])/1.e6,color='brown',s=5,edgecolor='none',marker='^',lw=0.1,zorder=2,alpha=0.2) 
