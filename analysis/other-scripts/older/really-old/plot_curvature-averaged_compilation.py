...
from functions import get_curvature_mean_and_stdev
...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/averaged-curvature_compilation.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/averaged-curvature_compilation.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.pdf'])
...
# 50
dplot=47
plt.scatter(50-dplot,mean_m50_fixedSP,s=22.5,color='maroon',edgecolor='black',linewidth=0.25,zorder=3)
plt.plot([50-dplot,50-dplot], [mean_m50_fixedSP-stdev_m50_fixedSP,mean_m50_fixedSP+stdev_m50_fixedSP],  color='maroon',linewidth=3.5,zorder=2,alpha=0.5)
plt.scatter(50,mean_m50_bothfree,s=22.5,color='black',edgecolor='black',linewidth=0.25,zorder=3) 
plt.plot([50,50], [mean_m50_bothfree-stdev_m50_bothfree,mean_m50_bothfree+stdev_m50_bothfree],  color='black',linewidth=3.5,zorder=2,alpha=0.5)
plt.scatter(50+dplot,mean_m50_fixedOP,s=22.5,color='slategray',edgecolor='black',linewidth=0.25,zorder=3)
plt.plot([50+dplot,50+dplot], [mean_m50_fixedOP-stdev_m50_fixedOP,mean_m50_fixedOP+stdev_m50_fixedOP],  color='slategray',linewidth=3.5,zorder=2,alpha=0.5) 
# 250
plt.scatter(250-dplot,mean_m250_fixedSP,s=22.5,color='maroon',edgecolor='black',linewidth=0.25,zorder=3) 
plt.plot([250-dplot,250-dplot], [mean_m250_fixedSP-stdev_m250_fixedSP,mean_m250_fixedSP+stdev_m250_fixedSP],  color='maroon',linewidth=3.5,zorder=2,alpha=0.5)
plt.scatter(250,mean_m250_bothfree,s=22.5,color='black',edgecolor='black',linewidth=0.25,zorder=3) 
plt.plot([250,250], [mean_m250_bothfree-stdev_m250_bothfree,mean_m250_bothfree+stdev_m250_bothfree],  color='black',linewidth=3.5,zorder=2,alpha=0.5)
plt.scatter(250+dplot,mean_m250_fixedOP,s=22.5,color='slategray',edgecolor='black',linewidth=0.25,zorder=3) 
plt.plot([250+dplot,250+dplot], [mean_m250_fixedOP-stdev_m250_fixedOP,mean_m250_fixedOP+stdev_m250_fixedOP],  color='slategray',linewidth=3.5,zorder=2,alpha=0.5)
# 500
plt.scatter(500-dplot,mean_m500_fixedSP,s=22.5,color='maroon',edgecolor='black',linewidth=0.25,zorder=3) 
plt.plot([500-dplot,500-dplot], [mean_m500_fixedSP-stdev_m500_fixedSP,mean_m500_fixedSP+stdev_m500_fixedSP],  color='maroon',linewidth=3.5,zorder=2,alpha=0.5)
plt.scatter(500,mean_m500_bothfree,s=22.5,color='black',edgecolor='black',linewidth=0.25,zorder=3) 
plt.plot([500,500], [mean_m500_bothfree-stdev_m500_bothfree,mean_m500_bothfree+stdev_m500_bothfree],  color='black',linewidth=3.5,zorder=2,alpha=0.5)
plt.scatter(500+dplot,mean_m500_fixedOP,s=22.5,color='slategray',edgecolor='black',linewidth=0.25,zorder=3) 
plt.plot([500+dplot,500+dplot], [mean_m500_fixedOP-stdev_m500_fixedOP,mean_m500_fixedOP+stdev_m500_fixedOP],  color='slategray',linewidth=3.5,zorder=2,alpha=0.5)
# 1000
plt.scatter(1000-dplot,mean_m1000_fixedSP,s=22.5,color='maroon',edgecolor='black',linewidth=0.25,zorder=3) 
plt.plot([1000-dplot,1000-dplot], [mean_m1000_fixedSP-stdev_m1000_fixedSP,mean_m1000_fixedSP+stdev_m1000_fixedSP],  color='maroon',linewidth=3.5,zorder=2,alpha=0.5)
plt.scatter(1000,mean_m1000_bothfree,s=22.5,color='black',edgecolor='black',linewidth=0.25,zorder=3) 
plt.plot([1000,1000], [mean_m1000_bothfree-stdev_m1000_bothfree,mean_m1000_bothfree+stdev_m1000_bothfree],  color='black',linewidth=3.5,zorder=2,alpha=0.5)
plt.scatter(1000+dplot,mean_m1000_fixedOP,s=22.5,color='slategray',edgecolor='black',linewidth=0.25,zorder=3) 
plt.plot([1000+dplot,1000+dplot], [mean_m1000_fixedOP-stdev_m1000_fixedOP,mean_m1000_fixedOP+stdev_m1000_fixedOP],  color='slategray',linewidth=3.5,zorder=2,alpha=0.5)
