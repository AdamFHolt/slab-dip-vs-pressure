...
from functions import get_avg_forces_nondim_curvfiltered
...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/NEW/force-components-averaged-vs-viscosity.curvature-filtered.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/NEW/force-components-averaged-vs-viscosity.curvature-filtered.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.pdf'])
...
fixedSP_array[0,1], fixedSP_array[0,2], fixedSP_array[0,3], fixedSP_array[0,4], fixedSP_array[0,5] = get_avg_forces_nondim_curvfiltered(m50_fixedSP,curvature_thresh)
fixedSP_array[1,1], fixedSP_array[1,2], fixedSP_array[1,3], fixedSP_array[1,4], fixedSP_array[1,5] = get_avg_forces_nondim_curvfiltered(m250_fixedSP,curvature_thresh)
fixedSP_array[2,1], fixedSP_array[2,2], fixedSP_array[2,3], fixedSP_array[2,4], fixedSP_array[2,5] = get_avg_forces_nondim_curvfiltered(m375_fixedSP,curvature_thresh)
fixedSP_array[3,1], fixedSP_array[3,2], fixedSP_array[3,3], fixedSP_array[3,4], fixedSP_array[3,5] = get_avg_forces_nondim_curvfiltered(m500_fixedSP,curvature_thresh)
fixedSP_array[4,1], fixedSP_array[4,2], fixedSP_array[4,3], fixedSP_array[4,4], fixedSP_array[4,5] = get_avg_forces_nondim_curvfiltered(m1000_fixedSP,curvature_thresh)

bothfree_array = np.zeros((5,6))
bothfree_array[0:5,0] = [50,250,375,500,675]
bothfree_array[0,1], bothfree_array[0,2], bothfree_array[0,3], bothfree_array[0,4], bothfree_array[0,5] = get_avg_forces_nondim_curvfiltered(m50_bothfree,curvature_thresh)
bothfree_array[1,1], bothfree_array[1,2], bothfree_array[1,3], bothfree_array[1,4], bothfree_array[1,5] = get_avg_forces_nondim_curvfiltered(m250_bothfree,curvature_thresh)
bothfree_array[2,1], bothfree_array[2,2], bothfree_array[2,3], bothfree_array[2,4], bothfree_array[2,5] = get_avg_forces_nondim_curvfiltered(m375_bothfree,curvature_thresh)
bothfree_array[3,1], bothfree_array[3,2], bothfree_array[3,3], bothfree_array[3,4], bothfree_array[3,5] = get_avg_forces_nondim_curvfiltered(m500_bothfree,curvature_thresh)
bothfree_array[4,1], bothfree_array[4,2], bothfree_array[4,3], bothfree_array[4,4], bothfree_array[4,5] = get_avg_forces_nondim_curvfiltered(m1000_bothfree,curvature_thresh)

fixedOP_array = np.zeros((5,6))
fixedOP_array[0:5,0] = [50,250,375,500,675]
fixedOP_array[0,1], fixedOP_array[0,2], fixedOP_array[0,3], fixedOP_array[0,4], fixedOP_array[0,5] = get_avg_forces_nondim_curvfiltered(m50_fixedOP,curvature_thresh)
fixedOP_array[1,1], fixedOP_array[1,2], fixedOP_array[1,3], fixedOP_array[1,4], fixedOP_array[1,5] = get_avg_forces_nondim_curvfiltered(m250_fixedOP,curvature_thresh)
fixedOP_array[2,1], fixedOP_array[2,2], fixedOP_array[2,3], fixedOP_array[2,4], fixedOP_array[2,5] = get_avg_forces_nondim_curvfiltered(m375_fixedOP,curvature_thresh)
fixedOP_array[3,1], fixedOP_array[3,2], fixedOP_array[3,3], fixedOP_array[3,4], fixedOP_array[3,5] = get_avg_forces_nondim_curvfiltered(m500_fixedOP,curvature_thresh)
fixedOP_array[4,1], fixedOP_array[4,2], fixedOP_array[4,3], fixedOP_array[4,4], fixedOP_array[4,5] = get_avg_forces_nondim_curvfiltered(m1000_fixedOP,curvature_thresh)
...
plt.scatter(fixedSP_array[:,0],(fixedSP_array[:,4]+fixedSP_array[:,5])/fixedSP_array[:,1],s=20,color='blue',edgecolor='blue',linewidth=0.25,zorder=3,marker='^')
...
plt.scatter(bothfree_array[:,0],(bothfree_array[:,4]+bothfree_array[:,5])/bothfree_array[:,1],s=20,color='blue',edgecolor='blue',linewidth=0.25,zorder=3,marker='^')
...
plt.scatter(fixedOP_array[:,0],(fixedOP_array[:,4]+fixedOP_array[:,5])/fixedOP_array[:,1],s=20,color='blue',edgecolor='blue',linewidth=0.25,zorder=3,marker='^')
