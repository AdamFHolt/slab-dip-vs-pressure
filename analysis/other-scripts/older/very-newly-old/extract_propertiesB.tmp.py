...
saved_stresses_name = ''.join(['text_files/TESTB/',model_name,'.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.txt'])
print(saved_stresses_name)

# where to put the plots
plot_loc   = ''.join(['plots/evolution/250km/',str(model_name)])
