...
from functions_plotting import plot_forcecomponent_dqds, plot_forcecomponent_dpmisfit, plot_dK
...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/K-and-dK.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/K-and-dK.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.pdf'])
...
# # plot model DP misfit vs. x-axis variableplot_forcecomponent_KN
...
plot_dK(tmin,m50_fixedSP,curve_thresh,'tan','v',misfit_color)
plot_dK(tmin,m50_bothfree,curve_thresh,'tan','o',misfit_color)
plot_dK(tmin,m50_fixedOP,curve_thresh,'tan','^',misfit_color)

plot_dK(tmin,m250_fixedSP,curve_thresh,'peru','v',misfit_color)
plot_dK(tmin,m250_bothfree,curve_thresh,'peru','o',misfit_color)
plot_dK(tmin,m250_fixedOP,curve_thresh,'peru','^',misfit_color)

plot_dK(tmin,m375_fixedSP,curve_thresh,'firebrick','v',misfit_color)
plot_dK(tmin,m375_bothfree,curve_thresh,'firebrick','o',misfit_color)
plot_dK(tmin,m375_fixedOP,curve_thresh,'firebrick','^',misfit_color)

plot_dK(tmin,m500_fixedSP,curve_thresh,'maroon','v',misfit_color)
plot_dK(tmin,m500_bothfree,curve_thresh,'maroon','o',misfit_color)
plot_dK(tmin,m500_fixedOP,curve_thresh,'maroon','^',misfit_color)

plot_dK(tmin,m1000_fixedSP,curve_thresh,'black','v',misfit_color)
plot_dK(tmin,m1000_bothfree,curve_thresh,'black','o',misfit_color)
plot_dK(tmin,m1000_fixedOP,curve_thresh,'black','^',misfit_color)


# axis stuff
# plt.ylim(-3,  3); 
plt.xlim(-0.001,  0.003); 
plt.ylabel(r"$dK/dS$   [1/km^2]")
plt.xlabel(r'$K$    [1/km]')
ax.set_xticks([-0.001, 0, 0.001, 0.002, 0.003])
ax.set_xticklabels([-0.001, 0, 0.001, 0.002, 0.003])
ax.xaxis.set_minor_locator(plt.MultipleLocator(0.0005))
