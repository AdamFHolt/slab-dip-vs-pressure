...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/force-components-all-vs-scaling.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.non-dim.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/force-components-all-vs-scaling.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.non-dim.pdf'])
...
mant_visc = 2.5e20
m50_bothfree[:,vc_ind] 	=  m50_bothfree[:,K_ind]    * 50 * mant_visc   * m50_bothfree[:,vc_ind]   * cmyr_to_ms * 1e-6
m50_fixedSP[:,vc_ind] 	=  m50_fixedSP[:,K_ind]     * 50 * mant_visc   * m50_fixedSP[:,vc_ind]    * cmyr_to_ms * 1e-6
m50_fixedOP[:,vc_ind] 	=  m50_fixedOP[:,K_ind]     * 50 * mant_visc   * m50_fixedOP[:,vc_ind]    * cmyr_to_ms * 1e-6
m250_bothfree[:,vc_ind] 	=  m250_bothfree[:,K_ind]   * 250 * mant_visc  * m250_bothfree[:,vc_ind]  * cmyr_to_ms * 1e-6
m250_fixedSP[:,vc_ind] 	=  m250_fixedSP[:,K_ind]    * 250 * mant_visc  * m250_fixedSP[:,vc_ind]   * cmyr_to_ms * 1e-6
m250_fixedOP[:,vc_ind] 	=  m250_fixedOP[:,K_ind]    * 250 * mant_visc  * m250_fixedOP[:,vc_ind]   * cmyr_to_ms * 1e-6
m375_bothfree[:,vc_ind] 	=  m375_bothfree[:,K_ind]   * 375 * mant_visc  * m375_bothfree[:,vc_ind]  * cmyr_to_ms * 1e-6
m375_fixedSP[:,vc_ind] 	=  m375_fixedSP[:,K_ind]    * 375 * mant_visc  * m375_fixedSP[:,vc_ind]   * cmyr_to_ms * 1e-6
m375_fixedOP[:,vc_ind] 	=  m375_fixedOP[:,K_ind]    * 375 * mant_visc  * m375_fixedOP[:,vc_ind]   * cmyr_to_ms * 1e-6
m500_bothfree[:,vc_ind] 	=  m500_bothfree[:,K_ind]   * 500 * mant_visc  * m500_bothfree[:,vc_ind]  * cmyr_to_ms * 1e-6
m500_fixedSP[:,vc_ind] 	=  m500_fixedSP[:,K_ind]    * 500 * mant_visc  * m500_fixedSP[:,vc_ind]   * cmyr_to_ms * 1e-6
m500_fixedOP[:,vc_ind] 	=  m500_fixedOP[:,K_ind]    * 500 * mant_visc  * m500_fixedOP[:,vc_ind]   * cmyr_to_ms * 1e-6
m1000_bothfree[:,vc_ind] =  m1000_bothfree[:,K_ind]  * 1000 * mant_visc * m1000_bothfree[:,vc_ind] * cmyr_to_ms * 1e-6
m1000_fixedSP[:,vc_ind] 	=  m1000_fixedSP[:,K_ind]   * 1000 * mant_visc * m1000_fixedSP[:,vc_ind]  * cmyr_to_ms * 1e-6
m1000_fixedOP[:,vc_ind] 	=  m1000_fixedOP[:,K_ind]   * 1000 *mant_visc  *  m1000_fixedOP[:,vc_ind] * cmyr_to_ms * 1e-6
...
# 50
plt.scatter(m50_fixedSP[tmin:,K_ind]*1e3, -1.0*(m50_fixedSP[tmin:,DP_ind]-m50_fixedSP[tmin:,anal_ind]+m50_fixedSP[tmin:,ss_ind]-m50_fixedSP[tmin:,sn_ind])/m50_fixedSP[tmin:,anal_ind],s=10,color='tan',edgecolor='black',linewidth=0.25,zorder=3,marker='v')
plt.scatter(m50_bothfree[tmin:,K_ind]*1e3, -1.0*(m50_bothfree[tmin:,DP_ind]-m50_bothfree[tmin:,anal_ind]+m50_bothfree[tmin:,ss_ind]-m50_bothfree[tmin:,sn_ind])/m50_bothfree[tmin:,anal_ind],s=10,color='tan',edgecolor='black',linewidth=0.25,zorder=3)
plt.scatter(m50_fixedOP[tmin:,K_ind]*1e3, -1.0*(m50_fixedOP[tmin:,DP_ind]-m50_fixedOP[tmin:,anal_ind]+m50_fixedOP[tmin:,ss_ind]-m50_fixedOP[tmin:,sn_ind])/m50_fixedOP[tmin:,anal_ind],s=10,color='tan',edgecolor='black',linewidth=0.25,zorder=3,marker='^')
# 250
plt.scatter(m250_fixedSP[tmin:,K_ind]*1e3, -1.0*(m250_fixedSP[tmin:,DP_ind]-m250_fixedSP[tmin:,anal_ind]+m250_fixedSP[tmin:,ss_ind]-m250_fixedSP[tmin:,sn_ind])/m250_fixedSP[tmin:,anal_ind],s=10,color='peru',edgecolor='black',linewidth=0.25,zorder=3,marker='v')
plt.scatter(m250_bothfree[tmin:,K_ind]*1e3, -1.0*(m250_bothfree[tmin:,DP_ind]-m250_bothfree[tmin:,anal_ind]+m250_bothfree[tmin:,ss_ind]-m250_bothfree[tmin:,sn_ind])/m250_bothfree[tmin:,anal_ind],s=10,color='peru',edgecolor='black',linewidth=0.25,zorder=3)
plt.scatter(m250_fixedOP[tmin:,K_ind]*1e3, -1.0*(m250_fixedOP[tmin:,DP_ind]-m250_fixedOP[tmin:,anal_ind]+m250_fixedOP[tmin:,ss_ind]-m250_fixedOP[tmin:,sn_ind])/m250_fixedOP[tmin:,anal_ind],s=10,color='peru',edgecolor='black',linewidth=0.25,zorder=3,marker='^')
# 375
plt.scatter(m375_fixedSP[tmin:,K_ind]*1e3, -1.0*(m375_fixedSP[tmin:,DP_ind]-m375_fixedSP[tmin:,anal_ind]+m375_fixedSP[tmin:,ss_ind]-m375_fixedSP[tmin:,sn_ind])/m375_fixedSP[tmin:,anal_ind],s=10,color='firebrick',edgecolor='black',linewidth=0.25,zorder=3,marker='v')
plt.scatter(m375_bothfree[tmin:,K_ind]*1e3, -1.0*(m375_bothfree[tmin:,DP_ind]-m375_bothfree[tmin:,anal_ind]+m375_bothfree[tmin:,ss_ind]-m375_bothfree[tmin:,sn_ind])/m375_bothfree[tmin:,anal_ind],s=10,color='firebrick',edgecolor='black',linewidth=0.25,zorder=3)
plt.scatter(m375_fixedOP[tmin:,K_ind]*1e3, -1.0*(m375_fixedOP[tmin:,DP_ind]-m375_fixedOP[tmin:,anal_ind]+m375_fixedOP[tmin:,ss_ind]-m375_fixedOP[tmin:,sn_ind])/m375_fixedOP[tmin:,anal_ind],s=10,color='firebrick',edgecolor='black',linewidth=0.25,zorder=3,marker='^')
# 500
plt.scatter(m500_fixedSP[tmin:,K_ind]*1e3, -1.0*(m500_fixedSP[tmin:,DP_ind]-m500_fixedSP[tmin:,anal_ind]+m500_fixedSP[tmin:,ss_ind]-m500_fixedSP[tmin:,sn_ind])/m500_fixedSP[tmin:,anal_ind],s=10,color='maroon',edgecolor='black',linewidth=0.25,zorder=3,marker='v')
plt.scatter(m500_bothfree[tmin:,K_ind]*1e3, -1.0*(m500_bothfree[tmin:,DP_ind]-m500_bothfree[tmin:,anal_ind]+m500_bothfree[tmin:,ss_ind]-m500_bothfree[tmin:,sn_ind])/m500_bothfree[tmin:,anal_ind],s=10,color='maroon',edgecolor='black',linewidth=0.25,zorder=3)
plt.scatter(m500_fixedOP[tmin:,K_ind]*1e3, -1.0*(m500_fixedOP[tmin:,DP_ind]-m500_fixedOP[tmin:,anal_ind]+m500_fixedOP[tmin:,ss_ind]-m500_fixedOP[tmin:,sn_ind])/m500_fixedOP[tmin:,anal_ind],s=10,color='maroon',edgecolor='black',linewidth=0.25,zorder=3,marker='^')
# 1000plot
plt.scatter(m1000_fixedSP[tmin:,K_ind]*1e3, -1.0*(m1000_fixedSP[tmin:,DP_ind]-m1000_fixedSP[tmin:,anal_ind]+m1000_fixedSP[tmin:,ss_ind]-m1000_fixedSP[tmin:,sn_ind])/m1000_fixedSP[tmin:,anal_ind],s=10,color='black',edgecolor='black',linewidth=0.25,zorder=3,marker='v')
plt.scatter(m1000_bothfree[tmin:,K_ind]*1e3, -1.0*(m1000_bothfree[tmin:,DP_ind]-m1000_bothfree[tmin:,anal_ind]+m1000_bothfree[tmin:,ss_ind]-m1000_bothfree[tmin:,sn_ind])/m1000_bothfree[tmin:,anal_ind],s=10,color='black',edgecolor='black',linewidth=0.25,zorder=3)
plt.scatter(m1000_fixedOP[tmin:,K_ind]*1e3, -1.0*(m1000_fixedOP[tmin:,DP_ind]-m1000_fixedOP[tmin:,anal_ind]+m1000_fixedOP[tmin:,ss_ind]-m1000_fixedOP[tmin:,sn_ind])/m1000_fixedOP[tmin:,anal_ind],s=10,color='black',edgecolor='black',linewidth=0.25,zorder=3,marker='^')

# axis stuff
# plt.ylim(-20,  20); 
plt.xlim(-0.001,  0.003); 
plt.ylabel(r'$B_{slab} - (\Delta P  +  \sigma_{slab})$')
plt.xlabel(r'$K$    [1/km]')
...
# 50
plt.scatter(m50_fixedSP[tmin:,K_ind]*1e3, m50_fixedSP[tmin:,ss_ind]/m50_fixedSP[tmin:,anal_ind],s=10,color='tan',edgecolor='black',linewidth=0.25,zorder=3,marker='v')
plt.scatter(m50_bothfree[tmin:,K_ind]*1e3,m50_bothfree[tmin:,ss_ind]/m50_bothfree[tmin:,anal_ind],s=10,color='tan',edgecolor='black',linewidth=0.25,zorder=3)
plt.scatter(m50_fixedOP[tmin:,K_ind]*1e3, m50_fixedOP[tmin:,ss_ind]/m50_fixedOP[tmin:,anal_ind],s=10,color='tan',edgecolor='black',linewidth=0.25,zorder=3,marker='^')
# 250
plt.scatter(m250_fixedSP[tmin:,K_ind]*1e3, m250_fixedSP[tmin:,ss_ind]/m250_fixedSP[tmin:,anal_ind],s=10,color='peru',edgecolor='black',linewidth=0.25,zorder=3,marker='v')
plt.scatter(m250_bothfree[tmin:,K_ind]*1e3,m250_bothfree[tmin:,ss_ind]/m250_bothfree[tmin:,anal_ind],s=10,color='peru',edgecolor='black',linewidth=0.25,zorder=3)
plt.scatter(m250_fixedOP[tmin:,K_ind]*1e3, m250_fixedOP[tmin:,ss_ind]/m250_fixedOP[tmin:,anal_ind],s=10,color='peru',edgecolor='black',linewidth=0.25,zorder=3,marker='^')
# 375
plt.scatter(m375_fixedSP[tmin:,K_ind]*1e3, m375_fixedSP[tmin:,ss_ind]/m375_fixedSP[tmin:,anal_ind],s=10,color='firebrick',edgecolor='black',linewidth=0.25,zorder=3,marker='v')
plt.scatter(m375_bothfree[tmin:,K_ind]*1e3,m375_bothfree[tmin:,ss_ind]/m375_bothfree[tmin:,anal_ind],s=10,color='firebrick',edgecolor='black',linewidth=0.25,zorder=3)
plt.scatter(m375_fixedOP[tmin:,K_ind]*1e3, m375_fixedOP[tmin:,ss_ind]/m375_fixedOP[tmin:,anal_ind],s=10,color='firebrick',edgecolor='black',linewidth=0.25,zorder=3,marker='^')
# 500
plt.scatter(m500_fixedSP[tmin:,K_ind]*1e3, m500_fixedSP[tmin:,ss_ind]/m500_fixedSP[tmin:,anal_ind],s=10,color='maroon',edgecolor='black',linewidth=0.25,zorder=3,marker='v')
plt.scatter(m500_bothfree[tmin:,K_ind]*1e3,m500_bothfree[tmin:,ss_ind]/m500_bothfree[tmin:,anal_ind],s=10,color='maroon',edgecolor='black',linewidth=0.25,zorder=3)
plt.scatter(m500_fixedOP[tmin:,K_ind]*1e3, m500_fixedOP[tmin:,ss_ind]/m500_fixedOP[tmin:,anal_ind],s=10,color='maroon',edgecolor='black',linewidth=0.25,zorder=3,marker='^')
# 1000
plt.scatter(m1000_fixedSP[tmin:,K_ind]*1e3, m1000_fixedSP[tmin:,ss_ind]/m1000_fixedSP[tmin:,anal_ind],s=10,color='black',edgecolor='black',linewidth=0.25,zorder=3,marker='v')
plt.scatter(m1000_bothfree[tmin:,K_ind]*1e3,m1000_bothfree[tmin:,ss_ind]/m1000_bothfree[tmin:,anal_ind],s=10,color='black',edgecolor='black',linewidth=0.25,zorder=3)
plt.scatter(m1000_fixedOP[tmin:,K_ind]*1e3, m1000_fixedOP[tmin:,ss_ind]/m1000_fixedOP[tmin:,anal_ind],s=10,color='black',edgecolor='black',linewidth=0.25,zorder=3,marker='^')
