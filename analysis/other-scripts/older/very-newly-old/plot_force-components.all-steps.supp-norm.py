...
from functions_plotting import plot_forcecomponent_dqds, plot_forcecomponent_KN, plot_forcecomponent_N
...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/force-components-all-vs-scaling.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.SUPP-NORM.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/force-components-all-vs-scaling.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.SUPP-NORM.pdf'])
...
plot_forcecomponent_N(tmin,m50_fixedSP,curve_thresh,'tan','v',misfit_color)
plot_forcecomponent_N(tmin,m50_bothfree,curve_thresh,'tan','o',misfit_color)
plot_forcecomponent_N(tmin,m50_fixedOP,curve_thresh,'tan','^',misfit_color)

plot_forcecomponent_N(tmin,m250_fixedSP,curve_thresh,'peru','v',misfit_color)
plot_forcecomponent_N(tmin,m250_bothfree,curve_thresh,'peru','o',misfit_color)
plot_forcecomponent_N(tmin,m250_fixedOP,curve_thresh,'peru','^',misfit_color)

plot_forcecomponent_N(tmin,m375_fixedSP,curve_thresh,'firebrick','v',misfit_color)
plot_forcecomponent_N(tmin,m375_bothfree,curve_thresh,'firebrick','o',misfit_color)
plot_forcecomponent_N(tmin,m375_fixedOP,curve_thresh,'firebrick','^',misfit_color)

plot_forcecomponent_N(tmin,m500_fixedSP,curve_thresh,'maroon','v',misfit_color)
plot_forcecomponent_N(tmin,m500_bothfree,curve_thresh,'maroon','o',misfit_color)
plot_forcecomponent_N(tmin,m500_fixedOP,curve_thresh,'maroon','^',misfit_color)

plot_forcecomponent_N(tmin,m1000_fixedSP,curve_thresh,'black','v',misfit_color)
plot_forcecomponent_N(tmin,m1000_bothfree,curve_thresh,'black','o',misfit_color)
plot_forcecomponent_N(tmin,m1000_fixedOP,curve_thresh,'black','^',misfit_color)
