...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/force-components-all-vs-scalingD.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/force-components-all-vs-scalingD.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.pdf'])
...
# text files
text50_bothfree 		= ''.join(['text_files/TESTD/',name1_bothfree,'.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.txt'])
text50_fixedSP  		= ''.join(['text_files/TESTD/',name1_fixedSP,'.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.txt'])
text50_fixedOP  		= ''.join(['text_files/TESTD/',name1_fixedOP,'.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.txt'])
text250_bothfree    	= ''.join(['text_files/TESTD/',name3_bothfree,'.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.txt'])
text250_fixedSP     	= ''.join(['text_files/TESTD/',name3_fixedSP,'.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.txt'])
text250_fixedOP		    = ''.join(['text_files/TESTD/',name3_fixedOP,'.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.txt'])
text500_bothfree 		= ''.join(['text_files/TESTD/',name4_bothfree,'.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.txt'])
text500_fixedSP  		= ''.join(['text_files/TESTD/',name4_fixedSP,'.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.txt'])
text500_fixedOP  		= ''.join(['text_files/TESTD/',name4_fixedOP,'.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.txt'])
text1000_bothfree		= ''.join(['text_files/TESTD/',name5_bothfree,'.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.txt'])
text1000_fixedSP  		= ''.join(['text_files/TESTD/',name5_fixedSP,'.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.txt'])
text1000_fixedOP  		= ''.join(['text_files/TESTD/',name5_fixedOP,'.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.txt'])
text375_bothfree    	= ''.join(['text_files/TESTD/',name7_bothfree,'.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.txt'])
text375_fixedSP     	= ''.join(['text_files/TESTD/',name7_fixedSP,'.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.txt'])
text375_fixedOP	    	= ''.join(['text_files/TESTD/',name7_fixedOP,'.z',str(analysis_depth/1.e3),'.shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.txt'])
...
plot_forcecomponent_fullstressmisfit(tmin,m500_fixedOP,curve_thresh,'maroon','^',misfit_color)

plot_forcecomponent_fullstressmisfit(tmin,m1000_fixedSP,curve_thresh,'black','v',misfit_color)
plot_forcecomponent_fullstressmisfit(tmin,m1000_bothfree,curve_thresh,'black','o',misfit_color)
plot_forcecomponent_fullstressmisfit(tmin,m1000_fixedOP,curve_thresh,'black','^',misfit_color)

# axis stuff
plt.ylim(-20,  20); 
plt.xlim(-0.001,  0.003); 
plt.ylabel("full stress misfit [MPa]")
plt.ylabel(r'$B_{slab} - (\Delta P  +  \sigma_{slab})$   [MPa]')
plt.xlabel(r'$K$    [1/km]')
...
plot_forcecomponent_dpmisfit(tmin,m500_fixedOP,curve_thresh,x_ind,'maroon','^',misfit_color)

plot_forcecomponent_dpmisfit(tmin,m1000_fixedSP,curve_thresh,x_ind,'black','v',misfit_color)
plot_forcecomponent_dpmisfit(tmin,m1000_bothfree,curve_thresh,x_ind,'black','o',misfit_color)
plot_forcecomponent_dpmisfit(tmin,m1000_fixedOP,curve_thresh,x_ind,'black','^',misfit_color)

# axis stuff
plt.ylim(-20,  20); 
plt.xlim(-150, 800); 
plt.ylabel(r'$B_{slab} - \Delta P$   [MPa]')
...
plot_forcecomponent_KN(tmin,m500_fixedOP,curve_thresh,'maroon','^',misfit_color)

plot_forcecomponent_KN(tmin,m1000_fixedSP,curve_thresh,'black','v',misfit_color)
plot_forcecomponent_KN(tmin,m1000_bothfree,curve_thresh,'black','o',misfit_color)
plot_forcecomponent_KN(tmin,m1000_fixedOP,curve_thresh,'black','^',misfit_color)
