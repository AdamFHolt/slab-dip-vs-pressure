...
if depths == "normal":
    ...
    plot_name_png = ''.join(['plots/DP-comparisons/compilations/DP-vs-DP.dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.200-to-400kmB.png'])
    plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/DP-vs-DP.dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.200-to-400kmB.pdf'])
elif depths == "other":
    analysis_depth1 = 250e3
    analysis_depth2 = 300e3
    analysis_depth3 = 350e3
    plot_name_png = ''.join(['plots/DP-comparisons/compilations/DP-vs-DP.dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.250-to-350kmB.png'])
    plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/DP-vs-DP.dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.250-to-350kmB.pdf'])
else:
...
new2_fixedOP     = np.loadtxt((text2_new_fixedOP))
			# print("B: ",model[i,4]/1.e6," F: ",(model[i,3]-model[i,6]+model[i,17])/1.e6,"misfit: ",np.abs((model[i,4]-(model[i,3]-model[i,6]+model[i,17]))/1.e6))
			# print("DP: ",model[i,3]/1.e6," SS: ",model[i,17]/1.e6," SN: ",model[i,6]/1.e6)
...
plot_BvsDP_wKthresh(tmin,ref1b_fixedOP,curvature_thresh, 'maroon','black','^')
# 1000
plot_BvsDP_wKthresh(tmin,strong1_bothfree,curvature_thresh,'black','black','o')
plot_BvsDP_wKthresh(tmin,strong1_fixedSP,curvature_thresh, 'black','black','v')
plot_BvsDP_wKthresh(tmin,strong1_fixedOP,curvature_thresh, 'black','black','^')
...
plot_BvsDP_wKthresh(tmin,ref2b_fixedOP,curvature_thresh, 'maroon','black','^')
# 1000
plot_BvsDP_wKthresh(tmin,strong2_bothfree,curvature_thresh,'black','black','o')
plot_BvsDP_wKthresh(tmin,strong2_fixedSP,curvature_thresh, 'black','black','v')
plot_BvsDP_wKthresh(tmin,strong2_fixedOP,curvature_thresh, 'black','black','^')
...
plot_BvsDP_wKthresh(tmin,ref3b_fixedOP,curvature_thresh, 'maroon','black','^')
# 1000
plot_BvsDP_wKthresh(tmin,strong3_bothfree,curvature_thresh,'black','black','o')
plot_BvsDP_wKthresh(tmin,strong3_fixedSP,curvature_thresh, 'black','black','v')
plot_BvsDP_wKthresh(tmin,strong3_fixedOP,curvature_thresh, 'black','black','^')
