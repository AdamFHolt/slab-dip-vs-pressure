...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/forces-vs-scaling.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.no-ot.logx.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/forces-vs-scaling.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.no-ot.logx.pdf'])
...
# log x-axis version: fold negative-K points via |scaling|
for m in [m50_bothfree, m50_fixedSP, m50_fixedOP, m250_bothfree, m250_fixedSP, m250_fixedOP,
          m375_bothfree, m375_fixedSP, m375_fixedOP, m500_bothfree, m500_fixedSP, m500_fixedOP,
