...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/forces-vs-scaling-supp.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.no-ot.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/forces-vs-scaling-supp.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.no-ot.pdf'])
...
plot_forcecomponent_dqds_vsK_overturned(tmin,m500_fixedOP,x_ind,'maroon','^')

plot_forcecomponent_dqds_vsK(tmin,m1000_fixedSP,curve_thresh,x_ind,'black','v',misfit_color)
plot_forcecomponent_dqds_vsK_overturned(tmin,m1000_bothfree,x_ind,'black','o')
plot_forcecomponent_dqds_vsK_overturned(tmin,m1000_fixedOP,x_ind,'black','^')
...
plot_forcecomponent_dqds_vsVc_overturned(tmin,m500_fixedOP,x_ind,'maroon','^')

plot_forcecomponent_dqds_vsVc(tmin,m1000_fixedSP,curve_thresh,x_ind,'black','v',misfit_color)
plot_forcecomponent_dqds_vsVc_overturned(tmin,m1000_bothfree,x_ind,'black','o')
plot_forcecomponent_dqds_vsVc_overturned(tmin,m1000_fixedOP,x_ind,'black','^')
...
plot_forcecomponent_dqds_vsVisc_overturned(tmin,m500_fixedOP,x_ind,'maroon','^',500*mant_visc)

plot_forcecomponent_dqds_vsVisc(tmin,m1000_fixedSP,curve_thresh,x_ind,'black','v',misfit_color,1000*mant_visc)
plot_forcecomponent_dqds_vsVisc_overturned(tmin,m1000_bothfree,x_ind,'black','o',1000*mant_visc)
plot_forcecomponent_dqds_vsVisc_overturned(tmin,m1000_fixedOP,x_ind,'black','^',1000*mant_visc)
