#!/bin/python
# WITH-T VARIANT of plot_forces.supp-shear.no-ot.py, generated by hand from it.
...
plot_name_png = ''.join(['plots/DP-comparisons/compilations/forces-vs-scaling-supp.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.no-ot.withT.png'])
plot_name_pdf = ''.join(['plots/DP-comparisons/compilations/forces-vs-scaling-supp.z',str(analysis_depth/1.e3),'shear-dz',str(analysis_depth_dz/1.e3),'.ds',str(ds/1.e3),'.prof-dz',str(dz/1.e3),'km.tmin',str(tmin),'.no-ot.withT.pdf'])
