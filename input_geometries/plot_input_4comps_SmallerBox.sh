...
rm tmp.ps tmp1.grd tmp2.grd tmp3.grd  tmp4.grd slab.c.cpt input1.txt input2.txt input3.txt input4.txt 2> /dev/null
...
gmt grdimage -Cslab.c.cpt tmp4.grd -Bn -K -O -Y-5 $reg $proj >> tmp.ps
